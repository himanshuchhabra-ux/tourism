  ...
  var addPageConfigs = [
    {
      ...
      redirect: "service-providers.html",
      label: "Provider",
    },
    {
    ...
    {
      formId: "addRestaurantForm",
      redirect: "restaurants.html",
      label: "Restaurant",
    },
    { formId: "addPackageForm", redirect: "packages.html", label: "Package" },
    {
      formId: "addActivityForm",
      redirect: "activities.html",
      label: "Activity",
    },
    { formId: "addCabForm", redirect: "cabs.html", label: "Cab" },
    {
      formId: "addSubscriptionForm",
      redirect: "subscriptions.html",
      label: "Plan",
    },
...
function initializeLoginPage() {
  ...
  function show2FAStep() {
    ...
    var loginBtn = document.getElementById("loginBtn");
    var formGroups = loginForm.querySelectorAll(
      ".form-group, .form-options, .twofa-toggle-wrapper",
    );
  ...
  if (verifyBtn) {
    verifyBtn.addEventListener("click", function () {
      ...
      verifyBtn.innerHTML =
        '<span>Verifying...</span> <i class="fas fa-spinner fa-spin"></i>';
      setTimeout(function () {
        window.location.href = "dashboard.html";
      }, 800);
    });
...
const hotelsData = {
  "HTL-001": {
    ...
    checkOut: "12:00",
    description:
      "Luxurious 5-star hotel in the heart of Riyadh offering world-class amenities and exceptional service.",
  ...
  "HTL-002": {
    ...
    checkOut: "12:00",
    description:
      "Beachfront resort with stunning Red Sea views and premium facilities for families and business travelers.",
  ...
  "HTL-003": {
    ...
    checkOut: "12:00",
    description:
      "Comfortable accommodation for Hajj and Umrah pilgrims with easy access to the Holy Mosque.",
    adminNotes:
      "High occupancy during pilgrimage seasons. Excellent guest reviews.",
  },
  "HTL-004": {
    id: "HTL-004",
    ...
    checkOut: "11:00",
    description:
      "Traditional hotel near the Prophet's Mosque offering comfortable stays for religious visitors.",
  ...
  "HTL-005": {
    ...
    checkOut: "12:00",
    description:
      "Modern business hotel catering to corporate travelers with excellent meeting facilities.",
    adminNotes:
      "Pending documentation verification. Minor compliance issues to resolve.",
  },
  "HTL-006": {
    id: "HTL-006",
    ...
    checkOut: "11:00",
    description:
      "Scenic mountain resort offering breathtaking views and a peaceful retreat from city life.",
  ...
  "HTL-007": {
    ...
    checkOut: "10:00",
    description:
      "Unique glamping experience near historical sites with authentic Bedouin-style accommodations.",
    adminNotes:
      "Flagged for safety compliance review. Interesting concept needs improvements.",
  },
  "HTL-008": {
    id: "HTL-008",
    ...
    checkOut: "12:00",
    description:
      "Convenient transit hotel for travelers with early flights or layovers.",
...
function filterHotels() {
  const searchTerm =
    document.getElementById("hotelSearchInput")?.value.toLowerCase() || "";
  const statusFilter =
    document.getElementById("hotelStatusFilter")?.value || "all";
  const locationFilter =
    document.getElementById("hotelLocationFilter")?.value || "all";
  ...
  rows.forEach((row) => {
    ...
    const matchesStars =
      starFilter === "all" || row.dataset.stars === starFilter;
...
function populateHotelView(hotel) {
  ...
  document.getElementById("viewHotelCleanliness").textContent =
    hotel.cleanliness + "/5.0";
  document.getElementById("viewHotelService").textContent =
    hotel.service + "/5.0";
  document.getElementById("viewHotelFacilities").textContent =
    hotel.facilities + "/5.0";

  // Performance stats
  document.getElementById("viewHotelBookings").textContent =
  ...
  const complianceClass =
    hotel.compliance === "compliant"
      ? "compliant"
      : hotel.compliance === "minor-issues"
        ? "minor-issues"
        : "non-compliant";
  ...
  complianceContainer.innerHTML = `
            <div class="compliance-item">
                ...
                <span class="compliance-badge ${complianceClass}">${hotel.compliance
                  .split("-")
...
function populateHotelEdit(hotel) {
  ...
  document.getElementById("editHotelLocation").value =
  ...
  document.getElementById("editHotelDescription").value =
    hotel.description || "";
  document.getElementById("editHotelCheckIn").value = hotel.checkIn || "14:00";
  document.getElementById("editHotelCheckOut").value =
...
const restaurantsData = {
  ...
  "RST-003": {
    ...
    description:
      "Authentic Italian cuisine with imported ingredients and wood-fired pizzas.",
  ...
  "RST-007": {
    ...
    adminNotes:
      "Flagged for health score review. Follow-up inspection scheduled.",
  },
  "RST-008": {
    id: "RST-008",
...
function populateRestaurantView(restaurant) {
  ...
  document.getElementById("viewRestaurantLocation").textContent =
    restaurant.location;
  ...
  // Ratings
  document.getElementById("viewRestaurantOverallRating").textContent =
    restaurant.rating;
  ...
  document.getElementById("viewRestaurantReservations").textContent =
    restaurant.reservations.toLocaleString();
  document.getElementById("viewRestaurantRevenue").textContent =
    restaurant.revenue;
  document.getElementById("viewRestaurantTurnover").textContent =
    restaurant.turnover;
  document.getElementById("viewRestaurantRetention").textContent =
  ...
  const complianceContainer = document.getElementById(
    "viewRestaurantCompliance",
  );
  const complianceClass =
    restaurant.compliance === "compliant"
      ? "compliant"
      : restaurant.compliance === "minor-issues"
        ? "minor-issues"
        : "non-compliant";
  const complianceIcon =
    restaurant.compliance === "compliant"
...
function populateRestaurantEdit(restaurant) {
  document.getElementById("editRestaurantDisplayName").textContent =
    restaurant.name;
  ...
  document.getElementById("editRestaurantCuisine").value = restaurant.cuisine
    .toLowerCase()
    .replace(" ", "-");
  document.getElementById("editRestaurantLocation").value =
  ...
  document.getElementById("editRestaurantPriceRange").value =
  ...
  document.getElementById("editRestaurantWebsite").value =
    restaurant.website || "";
  document.getElementById("editRestaurantOpenTime").value =
    restaurant.openTime || "11:00";
  document.getElementById("editRestaurantCloseTime").value =
    restaurant.closeTime || "23:00";
  document.getElementById("editRestaurantHealthScore").value =
    restaurant.healthScore;
  document.getElementById("editRestaurantCompliance").value =
    restaurant.compliance;
  document.getElementById("editRestaurantLicense").value =
    restaurant.license || "";
  ...
  document.getElementById("editRestaurantAdminNotes").value =
...
const packagesData = {
  "PKG-001": {
    ...
    bookings: 324,
    status: "active",
    provider: "Saudi Tours Co",
    groupSize: "2-15",
    minGroup: 2,
    maxGroup: 15,
    location: "Riyadh",
    description:
      "Explore the rich heritage of Riyadh with guided tours to historical sites.",
    inclusions: [
      "Hotel Accommodation",
      "Transportation",
      "Meals Included",
    ...
    itinerary: [
      {
        ...
        desc: "Airport pickup, hotel check-in, evening city drive",
      },
      {
        day: 2,
        title: "Historical Diriyah",
        desc: "Full day exploring At-Turaif UNESCO World Heritage Site",
      },
      {
        day: 3,
        title: "National Museum & Masmak",
        desc: "Visit National Museum, Masmak Fortress, and souks",
      },
      {
        day: 4,
        title: "Edge of the World",
        desc: "Day trip to Jebel Fihrayn with desert picnic lunch",
      },
      {
        day: 5,
        title: "Departure",
        desc: "Breakfast, souvenir shopping, airport transfer",
      },
    ],
    revenue: "SAR 810K",
    avgGroup: 6.2,
    ...
    created: "Mar 10, 2025",
    adminNotes:
      "Top-performing cultural package. Consistently positive reviews.",
  },
  "PKG-002": {
    id: "PKG-002",
    ...
    bookings: 186,
    status: "active",
    provider: "Coastal Trips Agency",
    groupSize: "4-12",
    minGroup: 4,
    maxGroup: 12,
    location: "Jeddah",
    description:
      "Premium diving experience in the crystal-clear waters of the Red Sea.",
    inclusions: [
      "Hotel Accommodation",
      "Diving Equipment",
      "Boat Transfers",
    ...
    itinerary: [
      {
        ...
        desc: "Equipment fitting, safety briefing, shallow reef dive",
      },
      {
        day: 2,
        title: "Deep Sea Exploration",
        desc: "Two deep dives at premium coral sites",
      },
      {
        day: 3,
        title: "Final Dive & Departure",
        desc: "Morning snorkel session, certification, departure",
      },
    ],
    revenue: "SAR 335K",
    avgGroup: 7.1,
    ...
    created: "Apr 05, 2025",
    adminNotes:
      "Highest-rated adventure package. Seasonal availability May-October.",
  },
  "PKG-003": {
    id: "PKG-003",
    ...
    bookings: 512,
    status: "active",
    provider: "Heritage Explorers",
    groupSize: "2-20",
    minGroup: 2,
    maxGroup: 20,
    location: "Mecca",
    description:
      "Complete Umrah package with premium accommodation and guided rituals.",
    inclusions: [
      "5-Star Hotel",
      "Transportation",
      "Meals Included",
    ...
    itinerary: [
      {
        ...
        desc: "Airport pickup, hotel check-in, Ihram preparation",
      },
      {
        day: 2,
        title: "Umrah Rituals",
        desc: "Guided Tawaf, Sa'i, and other Umrah rites",
      },
      {
        day: 3,
        title: "Mecca Exploration",
        desc: "Visit historical sites around Mecca",
      },
      {
        day: 4,
        title: "Transfer to Medina",
        desc: "Travel to Medina, hotel check-in",
      },
      {
        day: 5,
        title: "Medina Holy Sites",
        desc: "Visit Prophet's Mosque, Quba Mosque, Uhud",
      },
      {
        day: 6,
        title: "Medina Heritage",
        desc: "Explore Medina heritage sites and markets",
      },
  ...
  "PKG-004": {
    ...
    bookings: 145,
    status: "active",
    provider: "Desert Adventures Ltd",
    groupSize: "4-10",
    minGroup: 4,
    maxGroup: 10,
    location: "Al Ula",
    description:
      "Discover the ancient wonders of Hegra and the stunning landscapes of Al Ula.",
    inclusions: [
      "Boutique Hotel",
      "Transportation",
      "Meals Included",
    ...
    exclusions: [
      ...
      "Travel Insurance",
      "Personal Expenses",
      "Balloon Ride Upgrade",
    ],
    itinerary: [
      {
        day: 1,
        title: "Arrival at Al Ula",
        desc: "Airport transfer, resort check-in, sunset viewpoint",
      },
      {
        day: 2,
        title: "Hegra UNESCO Site",
        desc: "Full day exploring Hegra (Mada'in Saleh)",
      },
      {
        day: 3,
        title: "Elephant Rock & Oasis",
        desc: "Visit Elephant Rock, Old Town, date palm oasis",
      },
      {
        day: 4,
        title: "Hot Air Balloon & Departure",
        desc: "Sunrise balloon ride, breakfast, departure",
      },
    ],
    revenue: "SAR 464K",
    avgGroup: 5.8,
  ...
  "PKG-005": {
    ...
    bookings: 198,
    status: "active",
    provider: "Luxury Travel KSA",
    groupSize: "4-20",
    minGroup: 4,
    maxGroup: 20,
    location: "Jeddah",
    description:
      "Family-friendly package with kids activities, waterpark, and beach fun.",
    inclusions: [
      "Family Hotel",
      "Transportation",
      "Meals Included",
    ...
    itinerary: [
      {
        ...
        desc: "Hotel check-in, private beach, welcome dinner",
      },
      {
        day: 2,
        title: "Waterpark Adventure",
        desc: "Full day at premium waterpark with all rides",
      },
      {
        day: 3,
        title: "Jeddah Corniche & Aquarium",
        desc: "Corniche walk, Fakieh Aquarium, Al Balad",
      },
      {
        day: 4,
        title: "Shopping & Departure",
        desc: "Mall of Arabia visit, airport transfer",
      },
    ],
    revenue: "SAR 554K",
    avgGroup: 8.4,
  ...
  "PKG-006": {
    ...
    location: "Multi-City",
    description:
      "Affordable multi-city tour covering Riyadh, Jeddah, and Al Ula highlights.",
    inclusions: [
      "Hostel/Budget Hotel",
      "Bus Transport",
      "Breakfast",
    ...
    itinerary: [
      {
        day: 1,
        title: "Riyadh Start",
        desc: "Group meeting, city highlights walking tour",
      },
      {
        day: 2,
        title: "Riyadh Heritage",
        desc: "Diriyah, National Museum on a budget",
      },
      {
        day: 3,
        title: "Travel to Jeddah",
        desc: "Bus to Jeddah, evening Corniche walk",
      },
      {
        day: 4,
        title: "Al Balad & Coast",
        desc: "Historic Jeddah, local food tour, beach",
      },
      {
        day: 5,
        title: "Travel to Al Ula",
        desc: "Flight to Al Ula, sunset at Elephant Rock",
      },
      {
        day: 6,
        title: "Hegra & Departure",
        desc: "Morning Hegra visit, departure transfers",
      },
    ],
    revenue: "SAR 320K",
    avgGroup: 14.2,
  ...
  "PKG-007": {
    ...
    location: "Riyadh",
    description:
      "Ultra-luxury experience with private chauffeur, fine dining, and VIP access.",
    inclusions: [
      "5-Star Suite",
      "Private Chauffeur",
      "Fine Dining",
    ...
    itinerary: [
      {
        day: 1,
        title: "VIP Arrival",
        desc: "Limousine pickup, suite check-in, rooftop dinner",
      },
      {
        day: 2,
        title: "Private Heritage Tour",
        desc: "Private guide to Diriyah, exclusive lunch",
      },
      {
        day: 3,
        title: "Desert Glamping",
        desc: "Luxury desert camp, camel ride, stargazing",
      },
      {
        day: 4,
        title: "Spa & Fine Dining",
        desc: "Full spa day, Michelin-star dinner experience",
      },
      {
        day: 5,
        title: "Farewell",
        desc: "Brunch, souvenir shopping, VIP airport lounge",
      },
    ],
    revenue: "SAR 757K",
    avgGroup: 3.1,
  ...
  "PKG-008": {
    ...
    location: "Tabuk",
    description:
      "Experience snow and mountains in Tabuk during the winter season.",
    inclusions: [
      "Mountain Lodge",
      "Transportation",
      "Meals",
    ...
    exclusions: [
      ...
      "Travel Insurance",
      "Personal Expenses",
      "Ski Equipment Upgrade",
    ],
    itinerary: [
      {
        day: 1,
        title: "Arrival in Tabuk",
        desc: "Airport transfer, lodge check-in, mountain viewpoint",
      },
      {
        day: 2,
        title: "Snow & Mountains",
        desc: "Snow activities, hiking, campfire dinner",
      },
      {
        day: 3,
        title: "Wadi Al Disah & Departure",
        desc: "Visit Wadi Al Disah canyon, departure",
      },
    ],
    revenue: "SAR 148K",
    avgGroup: 9.3,
...
function filterPackages() {
  const searchTerm =
    document.getElementById("packageSearchInput")?.value.toLowerCase() || "";
  const statusFilter =
    document.getElementById("packageStatusFilter")?.value || "all";
  const typeFilter =
    document.getElementById("packageTypeFilter")?.value || "all";
  const durationFilter =
    document.getElementById("packageDurationFilter")?.value || "all";
  ...
  rows.forEach((row) => {
    ...
    if (durationFilter === "1-3")
      matchesDuration = pkg.days >= 1 && pkg.days <= 3;
    else if (durationFilter === "4-7")
      matchesDuration = pkg.days >= 4 && pkg.days <= 7;
    else if (durationFilter === "8+") matchesDuration = pkg.days >= 8;

    row.style.display =
      matchesSearch && matchesStatus && matchesType && matchesDuration
        ? ""
        : "none";
  });
}
  ...
  document.addEventListener("click", function (e) {
    if (
      ...
      if (packagesData[pkgId]) {
        packagesData[pkgId].status =
          packagesData[pkgId].status === "disabled" ? "active" : "disabled";
        populatePackagesTable();
      }
    }
  });
...
function populatePackageView(pkg) {
  ...
  document.getElementById("viewPackageAvatar").src =
  ...
  document.getElementById("viewPackagePrice").textContent =
    pkg.price + "/person";
  document.getElementById("viewPackageGroupSize").textContent =
    pkg.groupSize + " persons";
  document.getElementById("viewPackageRating").textContent =
    pkg.rating + "/5.0";
  ...
  // Performance stats
  document.getElementById("viewPackageBookings").textContent =
    pkg.bookings.toLocaleString();
  document.getElementById("viewPackageRevenue").textContent =
    pkg.revenue || "N/A";
  document.getElementById("viewPackageAvgGroup").textContent =
    pkg.avgGroup || "N/A";
  document.getElementById("viewPackageRepeatRate").textContent =
    pkg.repeatRate || "N/A";

  // Itinerary
  const itineraryEl = document.getElementById("viewPackageItinerary");
  if (itineraryEl && pkg.itinerary) {
    itineraryEl.innerHTML = pkg.itinerary
      .map(
        (item) => `
  ...
  if (inclusionsEl) {
    ...
    if (pkg.inclusions) {
      html +=
        '<div class="inclusions-column"><h4><i class="fas fa-check-circle"></i> Included</h4>' +
        pkg.inclusions
          .map(function (i) {
            return (
              '<div class="inclusion-item included"><i class="fas fa-check"></i> ' +
              i +
              "</div>"
            );
          })
    ...
    if (pkg.exclusions) {
      html +=
        '<div class="inclusions-column"><h4><i class="fas fa-times-circle" style="color:#e74c3c"></i> Excluded</h4>' +
        pkg.exclusions
          .map(function (i) {
            return (
              '<div class="inclusion-item excluded"><i class="fas fa-times"></i> ' +
              i +
              "</div>"
            );
          })
  ...
  if (complianceEl) {
    var compClass =
      pkg.compliance === "compliant"
        ? "compliant"
        : pkg.compliance === "minor-issues"
          ? "minor-issues"
          : "non-compliant";
    var compIcon =
      pkg.compliance === "compliant"
    ...
    complianceEl.innerHTML =
      '<div class="compliance-item">' +
      '<span class="compliance-item-label"><i class="fas ' +
      compIcon +
      '"></i> Overall Compliance</span>' +
  ...
  if (activityEl) {
    activityEl.innerHTML =
      ...
      '<div class="activity-content"><div class="activity-title">Package created</div><div class="activity-time">' +
      pkg.created +
      "</div></div>" +
      "</div>" +
      '<div class="activity-item">' +
      '<div class="activity-icon"><i class="fas fa-check-circle"></i></div>' +
      '<div class="activity-content"><div class="activity-title">Status set to ' +
      pkg.status +
      ...
      '<div class="activity-content"><div class="activity-title">' +
      pkg.bookings +
      ' bookings recorded</div><div class="activity-time">Updated recently</div></div>' +
      "</div>";
  }
}
...
const activitiesData = {
  "ACT-001": {
    ...
    bookings: 1856,
    status: "active",
    operator: "Desert Adventures Ltd",
    difficulty: "Moderate",
    location: "Riyadh",
    maxPax: 20,
    minAge: 12,
    description:
      "Thrilling desert safari with dune bashing, camel rides, and traditional Bedouin dinner.",
    includes: [
      "Professional Guide",
      "Transportation",
      "Camel Ride",
  ...
  "ACT-002": {
    ...
    bookings: 2340,
    status: "active",
    operator: "Heritage Explorers",
    difficulty: "Easy",
    location: "Jeddah",
    maxPax: 25,
    minAge: 6,
    description:
      "Guided walking tour through the historic Al Balad district with expert heritage guides.",
  ...
  "ACT-003": {
    ...
    bookings: 987,
    status: "active",
    operator: "Red Sea Diving Center",
    difficulty: "Easy",
    location: "Jeddah",
    maxPax: 15,
    minAge: 10,
    description:
      "Explore vibrant coral reefs and marine life in the crystal-clear Red Sea waters.",
    includes: [
      "Equipment Provided",
      "Professional Guide",
      "Transportation",
  ...
  "ACT-004": {
    ...
    bookings: 654,
    status: "active",
    operator: "Mountain Trails KSA",
    difficulty: "Challenging",
    location: "Tabuk",
    maxPax: 12,
    minAge: 16,
    description:
      "Full-day mountain hiking through scenic trails with panoramic views.",
    includes: [
      "Professional Guide",
      "Equipment Provided",
      "Meals/Snacks",
    ...
    created: "Mar 01, 2025",
    adminNotes:
      "High difficulty - ensure age/fitness requirements are enforced.",
  },
  "ACT-005": {
    id: "ACT-005",
    name: "Saudi Food Tour",
    category: "Food Tour",
    duration: "4 Hours",
    durationHrs: 4,
    price: "SAR 250",
    ...
    bookings: 1432,
    status: "active",
    operator: "Saudi Tours Co",
    difficulty: "Easy",
    location: "Riyadh",
    maxPax: 15,
    minAge: 5,
    description:
      "Taste authentic Saudi cuisine at local hidden gems with a professional food guide.",
    includes: [
      "Professional Guide",
      "All Food Tastings",
      "Refreshments",
  ...
  "ACT-006": {
    ...
    bookings: 423,
    status: "pending",
    operator: "Luxury Travel KSA",
    difficulty: "Easy",
    location: "Riyadh",
    maxPax: 8,
    minAge: 18,
    description:
      "Premium spa day including massage, thermal baths, and wellness consultation.",
  ...
  "ACT-007": {
    ...
    minAge: 8,
    description:
      "Professional stargazing experience in the pristine dark skies of Al Ula desert.",
    includes: [
      "Professional Guide",
      "Telescope Access",
      "Refreshments",
  ...
  "ACT-008": {
    ...
    minAge: 14,
    description:
      "Exciting sandboarding on massive dunes with professional instructors.",
...
function filterActivities() {
  const searchTerm =
    document.getElementById("activitySearchInput")?.value.toLowerCase() || "";
  const statusFilter =
    document.getElementById("activityStatusFilter")?.value || "all";
  const categoryFilter =
    document.getElementById("activityCategoryFilter")?.value || "all";
  const difficultyFilter =
    document.getElementById("activityDifficultyFilter")?.value || "all";
  ...
  rows.forEach((row) => {
    ...
    const matchesCategory =
      categoryFilter === "all" ||
      activity.category.toLowerCase().replace(" ", "-") === categoryFilter;
    const matchesDifficulty =
      difficultyFilter === "all" ||
      activity.difficulty.toLowerCase() === difficultyFilter;
  ...
  document.addEventListener("click", function (e) {
    if (
      ...
      if (activitiesData[actId]) {
        activitiesData[actId].status =
          activitiesData[actId].status === "disabled" ? "active" : "disabled";
        populateActivitiesTable();
      }
    }
  });
...
function populateActivityView(activity) {
  ...
  document.getElementById("viewActivityAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(activity.name) +
    "&background=f093fb&color=fff&size=120";
  ...
  document.getElementById("viewActivityCategory").textContent =
    activity.category;
  document.getElementById("viewActivityDuration").textContent =
    activity.duration;
  document.getElementById("viewActivityPrice").textContent =
    activity.price + "/person";
  document.getElementById("viewActivityDifficulty").textContent =
    activity.difficulty;
  document.getElementById("viewActivityMaxPax").textContent =
    activity.maxPax + " persons";
  document.getElementById("viewActivityRating").textContent =
    activity.rating + "/5.0";
  document.getElementById("viewActivityLocation").textContent =
    activity.location;
  document.getElementById("viewActivityOperator").textContent =
    activity.operator;

  // Schedule
  const scheduleEl = document.getElementById("viewActivitySchedule");
  if (scheduleEl && activity.schedule) {
    scheduleEl.innerHTML = activity.schedule.days
      .map(
        (day) => `
                <div class="hours-row">
  ...
  if (includesEl && activity.includes) {
    includesEl.innerHTML = activity.includes
      .map(
        (item) => `
...
function populateActivityEdit(activity) {
  document.getElementById("editActivityDisplayName").textContent =
    activity.name;
  ...
  document.getElementById("editActivityCommission").value =
    activity.commission || "";
  document.getElementById("editActivityAdminNotes").value =
    activity.adminNotes || "";

  if (activity.schedule) {
    document.getElementById("editActivityStartTime").value =
...
function setupCabActions() {
  document.addEventListener("click", function (e) {
    if (
      ...
      const cabId = row.dataset.cabId;
      if (cabsData[cabId]) {
        cabsData[cabId].status =
          cabsData[cabId].status === "disabled" ? "active" : "disabled";
        populateCabsTable();
      }
    }
  });
...
const bookingsData = {
  "BK-2025-001": {
    ...
    custEmail: "m.rashid@email.com",
    custPhone: "+966-50-555-6789",
    custNationality: "Saudi Arabia",
    serviceType: "hotel",
  ...
  "BK-2025-002": {
    id: "BK-2025-002",
    customer: "Sara Al Zahrani",
    custEmail: "s.zahrani@email.com",
    custPhone: "+966-50-555-4321",
    custNationality: "Saudi Arabia",
    serviceType: "package",
    ...
    amount: 5000,
    discount: 500,
    amountDisplay: "SAR 4,500",
    paymentStatus: "paid",
    paymentMethod: "Bank Transfer",
    transactionId: "TXN-88520",
    status: "confirmed",
  ...
  "BK-2025-003": {
    id: "BK-2025-003",
    customer: "Abdullah Al Ghamdi",
    custEmail: "a.ghamdi@email.com",
    custPhone: "+966-55-444-7890",
    custNationality: "Saudi Arabia",
    ...
    amount: 2100,
    discount: 0,
    amountDisplay: "SAR 2,100",
    paymentStatus: "paid",
    paymentMethod: "Digital Wallet",
    transactionId: "TXN-88634",
    status: "completed",
  ...
  "BK-2025-004": {
    ...
    custEmail: "f.harbi@email.com",
    custPhone: "+966-50-333-2211",
    custNationality: "Saudi Arabia",
    serviceType: "cab",
    ...
    amount: 350,
    discount: 0,
    amountDisplay: "SAR 350",
    paymentStatus: "paid",
    paymentMethod: "Credit Card",
    transactionId: "TXN-88701",
    status: "completed",
    vendor: "Omar Hassan (Driver)",
    vendorId: "CAB-003",
    commission: 15,
  ...
  "BK-2025-005": {
    ...
    custEmail: "j.wilson@email.com",
    custPhone: "+44-20-7123-4567",
    custNationality: "United Kingdom",
    serviceType: "hotel",
    ...
    amount: 6300,
    discount: 630,
    amountDisplay: "SAR 5,670",
    paymentStatus: "partial",
    paymentMethod: "Credit Card",
    transactionId: "TXN-88789",
    status: "pending",
  ...
  "BK-2025-006": {
    id: "BK-2025-006",
    customer: "Noura Al Mutairi",
    custEmail: "n.mutairi@email.com",
    custPhone: "+966-50-777-8899",
    custNationality: "Saudi Arabia",
    ...
    adminNotes:
      "Pay at venue. Birthday celebration - confirm cake order with vendor.",
  },
  "BK-2025-007": {
    id: "BK-2025-007",
    customer: "Hassan Al Dosari",
    custEmail: "h.dosari@email.com",
    custPhone: "+966-55-222-3344",
    custNationality: "Saudi Arabia",
    serviceType: "package",
    ...
    amount: 13500,
    discount: 675,
    amountDisplay: "SAR 12,825",
    paymentStatus: "refunded",
    paymentMethod: "Bank Transfer",
    transactionId: "TXN-87925",
    status: "cancelled",
    vendor: "Heritage Explorers",
    vendorId: "VND-010",
    commission: 10,
    commissionAmount: 1282.5,
    payout: 11542.5,
    specialRequest: "Wheelchair accessible rooms needed.",
    adminNotes:
      "Cancelled due to family emergency. Full refund processed on Mar 18.",
  },
  "BK-2025-008": {
    id: "BK-2025-008",
    customer: "Aisha Bint Ali",
    custEmail: "a.ali@email.com",
    custPhone: "+966-50-111-5566",
    custNationality: "Saudi Arabia",
    serviceType: "activity",
    ...
    amount: 500,
    discount: 0,
    amountDisplay: "SAR 500",
    paymentStatus: "paid",
    paymentMethod: "Debit Card",
    transactionId: "TXN-88845",
    status: "confirmed",
    vendor: "Saudi Tours Co",
    vendorId: "VND-008",
    commission: 13,
    ...
    adminNotes:
      "Allergy noted. Inform food tour guide about seafood restriction.",
  },
};
...
function filterBookings() {
  const searchTerm =
    document.getElementById("bookingSearchInput")?.value.toLowerCase() || "";
  const statusFilter =
...
function populateBookingView(booking) {
  ...
  document.getElementById("viewBookingTitle").textContent =
    "Booking " + booking.id;
  document.getElementById("viewBookingAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(booking.id.replace("BK-2025-", "")) +
    "&background=667eea&color=fff&size=120";
  document.getElementById("viewBookingServiceType").textContent =
  ...
  document.getElementById("viewBookingCustEmail").textContent =
    booking.custEmail;
...
function populateBookingEdit(booking) {
  ...
  document.getElementById("editBookingServiceLabel").textContent =
    booking.serviceType.charAt(0).toUpperCase() +
    booking.serviceType.slice(1) +
    " Booking";
...
function filterSubscriptions() {
  const searchTerm =
    document.getElementById("subscriptionSearchInput")?.value.toLowerCase() ||
    "";
  const statusFilter =
  ...
  document.addEventListener("click", function (e) {
    if (
      ...
      if (subscriptionsData[subId]) {
        subscriptionsData[subId].status =
          subscriptionsData[subId].status === "active" ? "inactive" : "active";
        populateSubscriptionsTable();
      }
    }
  });
...
function populateSubscriptionView(sub) {
  ...
  document.getElementById("viewSubAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(sub.planName) +
    "&background=8e44ad&color=fff&size=120";
...
const payoutsData = {
  "PAY-2025-001": {
    ...
    accountHolder: "Luxury Hotels Group LLC",
    accountNum: "****4521",
    iban: "SA03 8000 0000 6080 1016 4521",
  ...
  "PAY-2025-002": {
    ...
    net: 27200,
    adjustment: -500,
    adjustmentReason: "Refund adjustment for cancelled booking",
    status: "completed",
    priority: "normal",
    method: "bank-transfer",
    ref: "REF-88430",
    ...
    accountHolder: "Saudi Tours Co Ltd",
    accountNum: "****7834",
    iban: "SA44 1000 0000 0058 3200 7834",
  ...
  "PAY-2025-003": {
    ...
    bankName: "Riyad Bank",
    accountHolder: "Desert Adventures Ltd",
    accountNum: "****9012",
    iban: "SA67 2000 0000 0012 3456 9012",
  ...
  "PAY-2025-004": {
    ...
    accountNum: "****3456",
    iban: "SA80 8000 0000 1234 5678 3456",
  ...
  "PAY-2025-005": {
    ...
    accountHolder: "Coastal Hotels Co",
    accountNum: "****6789",
    iban: "SA15 4500 0000 6789 0123 6789",
  ...
  "PAY-2025-006": {
    ...
    gross: 15200,
    commissionRate: 10,
    commissionAmount: 1520,
    net: 13680,
    adjustment: 200,
    adjustmentReason: "Bonus for high customer satisfaction",
    status: "processing",
    priority: "normal",
    method: "bank-transfer",
    ref: "REF-88501",
    ...
    accountHolder: "Gourmet Dining Group LLC",
    accountNum: "****2345",
    iban: "SA22 5500 0000 9876 5432 2345",
  ...
  "PAY-2025-007": {
    ...
    net: 0,
    adjustment: -12825,
    adjustmentReason: "Full refund for cancelled booking BK-2025-007",
    status: "on-hold",
    priority: "urgent",
    method: "bank-transfer",
    ref: "",
    ...
    accountHolder: "Heritage Explorers Co",
    accountNum: "****8901",
    iban: "SA33 0500 0000 8765 4321 8901",
  ...
  "PAY-2025-008": {
    ...
    payoutDate: "",
    bankName: "Al Rajhi Bank",
    accountHolder: "Ahmed Al Fahad",
    accountNum: "****5678",
    iban: "SA99 8000 0000 2468 1357 5678",
    bookings: [],
    adminNotes:
      "Failed - bank account details mismatch. Contact vendor to verify IBAN.",
  },
};
...
function filterPayouts() {
  ...
  rows.forEach((row) => {
    ...
    const matchesSearch =
      payout.vendor.toLowerCase().includes(searchTerm) ||
  ...
  document.addEventListener("click", function (e) {
    if (
      ...
      if (payoutsData[payId]) {
        payoutsData[payId].status =
          payoutsData[payId].status === "on-hold" ? "pending" : "on-hold";
        populatePayoutsTable();
      }
    }
  });
...
function populatePayoutView(payout) {
  ...
  document.getElementById("viewPayoutTitle").textContent =
    "Payout " + payout.id;
  document.getElementById("viewPayoutAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(payout.id.replace("PAY-2025-", "")) +
    "&background=27ae60&color=fff&size=120";
  document.getElementById("viewPayoutVendorType").textContent =
    payout.vendorType.charAt(0).toUpperCase() +
    payout.vendorType.slice(1) +
    " Vendor";

  const statusEl = document.getElementById("viewPayoutStatus");
  statusEl.textContent =
    payout.status.charAt(0).toUpperCase() +
    payout.status.slice(1).replace("-", " ");
  ...
  document.getElementById("viewPayoutVendorId").textContent =
    "#" + payout.vendorId;
  document.getElementById("viewPayoutGross").textContent =
    "SAR " + payout.gross.toLocaleString();
  document.getElementById("viewPayoutCommission").textContent =
    payout.commissionRate +
    "% (SAR " +
    payout.commissionAmount.toLocaleString() +
    ")";
  document.getElementById("viewPayoutNet").textContent =
    "SAR " + payout.net.toLocaleString();
  document.getElementById("viewPayoutDate").textContent =
    payout.payoutDate || "Pending";
  document.getElementById("viewPayoutBank").textContent =
    payout.bankName + " " + payout.accountNum;
  document.getElementById("viewPayoutRef").textContent =
    payout.ref || "Pending";
  ...
  if (breakdownEl) {
    breakdownEl.innerHTML = `
                ...
                ${
                  payout.adjustment !== 0
                    ? `<div class="payment-row ${payout.adjustment < 0 ? "discount" : ""}">
  ...
  if (bookingsEl) {
    if (payout.bookings.length > 0) {
      bookingsEl.innerHTML = payout.bookings
        .map(
          (bkId) => `
                    <div class="info-item">
      ...
      bookingsEl.innerHTML =
        '<p style="color: var(--text-muted); font-size: 14px;">No bookings linked to this payout.</p>';
    }
  }

  // Banking
  document.getElementById("viewPayoutBankName").textContent = payout.bankName;
  document.getElementById("viewPayoutAccountHolder").textContent =
    payout.accountHolder;
  document.getElementById("viewPayoutAccountNum").textContent =
    payout.accountNum;
...
function populatePayoutEdit(payout) {
  ...
  document.getElementById("editPayoutVendorLabel").textContent =
    payout.vendorType.charAt(0).toUpperCase() +
    payout.vendorType.slice(1) +
    " Vendor";
  ...
  document.getElementById("editPayoutVendorType").value =
    payout.vendorType.charAt(0).toUpperCase() + payout.vendorType.slice(1);
  document.getElementById("editPayoutPeriod").value = payout.period;
  document.getElementById("editPayoutGross").value = payout.gross;
  document.getElementById("editPayoutCommissionRate").value =
    payout.commissionRate;
  document.getElementById("editPayoutCommissionAmount").value =
  ...
  document.getElementById("editPayoutAdjustmentReason").value =
  ...
  document.getElementById("editPayoutAdminNotes").value =
    payout.adminNotes || "";
}
...
function filterAds() {
  const searchTerm =
    document.getElementById("adSearchInput")?.value.toLowerCase() || "";
  const statusFilter =
...
function setupAdActions() {
  document.addEventListener("click", function (e) {
    if (
      ...
      if (adsData[adId]) {
        adsData[adId].status =
          adsData[adId].status === "active" ? "paused" : "active";
        populateAdsTable();
      }
    }
  });
...
function populateAdView(ad) {
  ...
  document.getElementById("viewAdAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(ad.name.substring(0, 2)) +
    "&background=e74c3c&color=fff&size=120";
...
const bannersData = {
  "BNR-001": {
    id: "BNR-001",
    name: "Summer Sale - Hotels 50% Off",
    ...
    created: "Feb 20, 2026",
    description:
      "Major summer promotion featuring up to 50% off on selected hotels across Saudi Arabia.",
    imageUrl:
      "https://placehold.co/1200x400/e67e22/ffffff?text=Summer+Sale+50%25+Off",
    altText: "Summer Hotel Sale - 50% Off",
    ctaText: "Book Now",
    bgColor: "#e67e22",
    impressions: 245000,
    clicks: 12250,
    ...
    conversions: 612,
    abEnabled: "yes",
    variantName: "Variant B - Blue Theme",
    trafficSplit: 50,
    variantImage:
      "https://placehold.co/1200x400/3498db/ffffff?text=Summer+Sale+Blue",
    variantImpressions: 240000,
    variantClicks: 10800,
    variantCtr: 4.5,
    variantConversions: 540,
    adminNotes:
      "Main summer campaign. A/B test shows orange variant outperforms blue by 11%.",
  },
  "BNR-002": {
    id: "BNR-002",
    name: "Umrah Season Packages",
    placement: "homepage-hero",
    status: "active",
    priority: 2,
    ...
    created: "Feb 10, 2026",
    description:
      "Promote premium Umrah packages with hotel and transport inclusions for the holy season.",
    imageUrl:
      "https://placehold.co/1200x400/2ecc71/ffffff?text=Umrah+Season+Packages",
    altText: "Umrah Season Special Packages",
    ...
    adminNotes:
      "High-performing campaign. Best CTR of all banners. Extended through April.",
  },
  "BNR-003": {
    id: "BNR-003",
    name: "New User Welcome - 20% Off",
    placement: "homepage-sidebar",
    status: "active",
    priority: 1,
    ...
    created: "Dec 28, 2025",
    description:
      "Welcome banner for first-time visitors offering 20% discount on first booking.",
    imageUrl:
      "https://placehold.co/400x300/9b59b6/ffffff?text=Welcome+20%25+Off",
    altText: "New User Welcome Offer",
    ctaText: "Claim Offer",
    bgColor: "#9b59b6",
    impressions: 156000,
    clicks: 9360,
    ...
    conversions: 468,
    abEnabled: "yes",
    variantName: "Variant B - 15% Off",
    trafficSplit: 30,
    variantImage:
      "https://placehold.co/400x300/e74c3c/ffffff?text=Welcome+15%25+Off",
    variantImpressions: 67000,
    variantClicks: 3350,
    variantCtr: 5.0,
    variantConversions: 167,
    adminNotes:
      "20% variant outperforms 15%. Keep traffic split at 70/30 for control.",
  },
  "BNR-004": {
    id: "BNR-004",
    ...
    created: "Feb 25, 2026",
    description:
      "Promotional banner for desert safari activities shown in search results.",
    imageUrl:
      "https://placehold.co/800x200/f39c12/ffffff?text=Desert+Safari+Adventures",
    altText: "Desert Safari Activities",
    ctaText: "Book Safari",
    bgColor: "#f39c12",
    impressions: 98000,
    clicks: 5880,
    ...
    variantConversions: 0,
    adminNotes:
      "Targeted at tourists. Only shows during peak hours for optimal engagement.",
  },
  "BNR-005": {
    id: "BNR-005",
    ...
    endDate: "Apr 10, 2026",
    displayHours: "evening",
    frequency: "always",
    audience: "all",
    createdBy: "Admin User",
    created: "Mar 01, 2026",
    description:
      "Ramadan season promotional banner with special hotel and dining offers.",
    imageUrl:
      "https://placehold.co/1200x400/1abc9c/ffffff?text=Ramadan+Special+Offers",
    altText: "Ramadan Special Deals",
    ctaText: "View Offers",
    bgColor: "#1abc9c",
    impressions: 0,
    clicks: 0,
    ...
    variantConversions: 0,
    adminNotes:
      "Scheduled for Ramadan. Displays only in evening hours. Review creative before launch.",
  },
  "BNR-006": {
    id: "BNR-006",
    ...
    created: "Feb 10, 2026",
    description:
      "Promotion for the newly launched cab service targeting business travelers.",
    imageUrl:
      "https://placehold.co/800x200/34495e/ffffff?text=Premium+Cab+Service",
    altText: "Premium Cab Service Launch",
    ctaText: "Try Now",
    bgColor: "#34495e",
    impressions: 45000,
    clicks: 1800,
    ...
    variantConversions: 0,
    adminNotes:
      "Paused due to low conversion rate. Need to optimize landing page before resuming.",
  },
  "BNR-007": {
    id: "BNR-007",
    ...
    created: "Jan 25, 2026",
    description:
      "Valentine season campaign promoting couple-friendly hotel and dining packages.",
    imageUrl:
      "https://placehold.co/1200x400/e74c3c/ffffff?text=Valentine+Getaway",
    altText: "Valentine Getaway Deals",
    ctaText: "Surprise Them",
    bgColor: "#e74c3c",
    impressions: 210000,
    clicks: 8400,
    ctr: 4.0,
    conversions: 420,
    abEnabled: "yes",
    variantName: "Variant B - Pink Theme",
    trafficSplit: 50,
    variantImage:
      "https://placehold.co/1200x400/ff69b4/ffffff?text=Valentine+Pink",
    variantImpressions: 205000,
    variantClicks: 9225,
    variantCtr: 4.5,
    variantConversions: 461,
    adminNotes:
      "Campaign completed. Pink variant performed slightly better. Use insights for next year.",
  },
  "BNR-008": {
    id: "BNR-008",
    ...
    created: "Mar 02, 2026",
    description:
      "Banner encouraging web users to download the TourHub mobile app.",
    imageUrl:
      "https://placehold.co/800x200/2c3e50/ffffff?text=Download+TourHub+App",
    altText: "Download TourHub App",
    ctaText: "Get the App",
    bgColor: "#2c3e50",
    impressions: 0,
    clicks: 0,
...
function populateBannerView(banner) {
  ...
  document.getElementById("viewBannerAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(banner.name.substring(0, 2)) +
    "&background=e67e22&color=fff&size=120";
...
function populateBannerEdit(banner) {
  ...
  document.getElementById("editBannerVariantName").value =
    banner.variantName || "";
  document.getElementById("editBannerTrafficSplit").value = banner.trafficSplit;
  document.getElementById("editBannerVariantImage").value =
    banner.variantImage || "";
  document.getElementById("editBannerAdminNotes").value =
    banner.adminNotes || "";
}
...
const scheduledReportsData = {
  ...
  "RPT-002": {
    ...
    type: "bookings",
    frequency: "monthly",
    recipients: "admin@tourhub.com, finance@tourhub.com",
  ...
  "RPT-004": {
    id: "RPT-004",
    name: "Ads Performance Weekly",
    type: "ads",
    frequency: "weekly",
    recipients: "marketing@tourhub.com",
    lastGenerated: "Feb 28, 2026",
    nextRun: "Mar 07, 2026",
    status: "active",
  },
  "RPT-005": {
    id: "RPT-005",
    name: "Vendor Payout Summary",
    type: "vendors",
    frequency: "monthly",
    recipients: "finance@tourhub.com",
    lastGenerated: "Mar 01, 2026",
    nextRun: "Apr 01, 2026",
    status: "active",
  },
  "RPT-006": {
    id: "RPT-006",
    name: "Quarterly Service Breakdown",
    type: "services",
    frequency: "quarterly",
    recipients: "admin@tourhub.com, ceo@tourhub.com",
  ...
  "RPT-007": {
    id: "RPT-007",
    name: "Daily Booking Alerts",
    type: "bookings",
    frequency: "daily",
    recipients: "operations@tourhub.com",
    lastGenerated: "Mar 03, 2026",
    nextRun: "Mar 04, 2026",
    status: "paused",
  },
  "RPT-008": {
  ...
  document.addEventListener("click", function (e) {
    if (
      ...
      if (scheduledReportsData[reportId]) {
        scheduledReportsData[reportId].status =
          scheduledReportsData[reportId].status === "active"
            ? "paused"
            : "active";
        populateScheduledReports();
      }
...
const refundsData = {
  "RFD-001": {
    ...
    bookingId: "BKG-1234",
    service: "hotel",
    serviceName: "Luxury Palace Hotel - Deluxe Suite",
    bookingAmount: 4500,
    refundAmount: 4050,
    deduction: 10,
    refundType: "full",
    ...
    gateway: "Stripe",
    txnRef: "TXN-STR-88421",
    requestDate: "Mar 01, 2026",
    processedDate: "",
    reason: "Change of travel plans due to family emergency",
    eligible: true,
    policyCheck: "Within 48-hour cancellation window",
    notifyEmail: "yes",
    notifySms: "yes",
    adminNotes:
      "High priority - family emergency. Customer has been loyal for 2+ years.",
  },
  "RFD-002": {
    id: "RFD-002",
    ...
    bookingId: "BKG-1198",
    service: "package",
    serviceName: "Umrah Premium Package - 7 Days",
    bookingAmount: 12000,
    refundAmount: 10800,
    deduction: 10,
    refundType: "full",
    ...
    gateway: "Stripe",
    txnRef: "TXN-STR-77312",
    requestDate: "Feb 25, 2026",
    processedDate: "Feb 27, 2026",
    reason: "Medical condition preventing travel",
    eligible: true,
    policyCheck: "Medical exemption with documentation provided",
    notifyEmail: "yes",
    notifySms: "yes",
    adminNotes:
      "Medical certificate verified. Approved for full refund minus processing fee.",
  },
  "RFD-003": {
    id: "RFD-003",
    ...
    bookingId: "BKG-1156",
    service: "activity",
    serviceName: "Desert Safari Adventure - Premium",
    bookingAmount: 850,
    refundAmount: 850,
    deduction: 0,
    refundType: "full",
    ...
    gateway: "Internal",
    txnRef: "TXN-INT-66201",
    requestDate: "Feb 20, 2026",
    processedDate: "Feb 22, 2026",
    reason: "Activity cancelled by provider due to weather",
    eligible: true,
    policyCheck: "Provider-initiated cancellation - full refund applicable",
    notifyEmail: "yes",
    notifySms: "no",
    adminNotes:
      "Provider cancelled due to sandstorm. Full refund to wallet credited.",
  },
  "RFD-004": {
    id: "RFD-004",
    ...
    bookingId: "BKG-1089",
    service: "hotel",
    serviceName: "Beach Resort & Spa - Ocean View",
    bookingAmount: 6200,
    refundAmount: 3100,
    deduction: 50,
    refundType: "partial",
    ...
    status: "processed",
    priority: "normal",
    paymentMethod: "Credit Card ****9156",
    gateway: "Stripe",
    txnRef: "TXN-STR-55103",
    requestDate: "Feb 18, 2026",
    processedDate: "Feb 20, 2026",
    reason: "Early checkout - stayed 3 of 6 nights",
    eligible: true,
    policyCheck: "Partial refund per early checkout policy",
    notifyEmail: "yes",
    notifySms: "yes",
  ...
  "RFD-005": {
    ...
    email: "moq@example.com",
    bookingId: "BKG-1312",
    service: "cab",
    serviceName: "Airport Transfer - Premium Sedan",
    bookingAmount: 350,
    refundAmount: 0,
    deduction: 100,
    refundType: "full",
  ...
  "RFD-006": {
    ...
    bookingId: "BKG-1278",
    service: "restaurant",
    serviceName: "Al Nakheel Fine Dining - Dinner for 4",
    bookingAmount: 1200,
    refundAmount: 1080,
    deduction: 10,
    refundType: "full",
    ...
    notifySms: "yes",
    adminNotes:
      "Restaurant was closed for renovation without notice. Vendor has been warned.",
  },
  "RFD-007": {
    id: "RFD-007",
    customer: "Khalid Al-Dosari",
    email: "khalid.d@example.com",
    bookingId: "BKG-1345",
    service: "package",
    serviceName: "Jeddah City Tour - 3 Days",
    bookingAmount: 3500,
    refundAmount: 2450,
    deduction: 30,
    refundType: "partial",
    ...
    gateway: "Stripe",
    txnRef: "TXN-STR-22445",
    requestDate: "Mar 03, 2026",
    processedDate: "",
    reason: "Flight cancelled - unable to reach destination",
    eligible: true,
    policyCheck: "Within 24-hour window. 30% deduction for late cancellation.",
    notifyEmail: "yes",
    notifySms: "yes",
    adminNotes:
      "Urgent - customer requesting expedited processing. Flight cancellation proof attached.",
  },
  "RFD-008": {
    id: "RFD-008",
    customer: "Nora Al-Harbi",
    email: "nora.h@example.com",
    bookingId: "BKG-1401",
    service: "hotel",
    serviceName: "Mountain View Lodge - Family Room",
    bookingAmount: 2800,
    refundAmount: 2520,
    deduction: 10,
    refundType: "full",
    ...
    status: "pending",
    priority: "normal",
    paymentMethod: "Debit Card ****3344",
    gateway: "Stripe",
    txnRef: "TXN-STR-11223",
    requestDate: "Mar 04, 2026",
    processedDate: "",
    reason: "Double booking - already booked elsewhere",
    eligible: true,
    policyCheck: "Standard cancellation policy applies. 10% processing fee.",
    notifyEmail: "yes",
    notifySms: "no",
    adminNotes: "",
  },
...
function filterRefunds() {
  ...
  rows.forEach((row) => {
    ...
    const matchesSearch =
      ...
      refund.customer.toLowerCase().includes(searchTerm) ||
...
function populateRefundView(refund) {
  ...
  document.getElementById("viewRefundTitle").textContent =
    "Refund " + refund.id;
  document.getElementById("viewRefundAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(refund.id.substring(0, 2)) +
    "&background=e74c3c&color=fff&size=120";
  document.getElementById("viewRefundBookingId").textContent =
    "#" + refund.bookingId;
  ...
  document.getElementById("viewRefundBookingAmount").textContent =
    "SAR " + refund.bookingAmount.toLocaleString();
  document.getElementById("viewRefundAmount").textContent =
    "SAR " + refund.refundAmount.toLocaleString();
  document.getElementById("viewRefundType").textContent =
    refund.refundType === "full"
      ? "Full Refund (" + (100 - refund.deduction) + "%)"
      : "Partial Refund (" + (100 - refund.deduction) + "%)";
  ...
  document.getElementById("viewRefundMethod").textContent =
...
function populateRefundEdit(refund) {
  ...
  document.getElementById("editRefundDisplayId").textContent =
    "#" + refund.bookingId;
  ...
  document.getElementById("editRefundCustomerDisplay").textContent =
    refund.customer;
  document.getElementById("editRefundBookingAmountDisplay").textContent =
    "SAR " + refund.bookingAmount.toLocaleString();
  ...
  document.getElementById("editRefundOriginalAmount").value =
  ...
  document.getElementById("editRefundPaymentMethod").value =
  ...
  document.getElementById("editRefundAdminNotes").value =
    refund.adminNotes || "";
}
...
const transactionsData = {
  "TXN-00001": {
    ...
    email: "ahmed@example.com",
    type: "booking",
    typeName: "Booking Payment",
    amount: 4500,
    currency: "SAR",
    method: "credit-card",
    methodName: "Credit Card ****4521",
    gateway: "Stripe",
    gatewayRef: "ch_3PqR5s2eZvKY3",
    status: "completed",
    date: "Mar 01, 2026 14:32",
    relatedId: "BKG-1234",
    relatedType: "Booking",
    commission: 12,
    commissionAmount: 540,
    netAmount: 3960,
    vendorName: "Luxury Palace Hotel",
    vendorId: "VND-015",
    settlementStatus: "settled",
    settlementDate: "Mar 03, 2026",
  ...
  "TXN-00002": {
    ...
    currency: "SAR",
    method: "debit-card",
    methodName: "Debit Card ****7832",
    gateway: "Stripe",
    gatewayRef: "ch_4TuV8w3fAkLZ6",
    status: "completed",
    date: "Feb 25, 2026 09:15",
    relatedId: "BKG-1198",
    relatedType: "Booking",
    commission: 10,
    commissionAmount: 1200,
    netAmount: 10800,
    vendorName: "Umrah Travel Co.",
    vendorId: "VND-022",
    settlementStatus: "settled",
  ...
  "TXN-00003": {
    ...
    gateway: "Internal",
    gatewayRef: "WAL-66201",
    status: "refunded",
    date: "Feb 20, 2026 16:45",
    relatedId: "BKG-1156",
    relatedType: "Booking",
    commission: 15,
    commissionAmount: 127.5,
    netAmount: 722.5,
    vendorName: "Desert Adventures LLC",
    vendorId: "VND-031",
    settlementStatus: "reversed",
    settlementDate: "Feb 22, 2026",
    gatewayStatus: "refunded",
    gatewayMessage: "Full refund processed",
    ip: "172.16.0.12",
    country: "Saudi Arabia",
  },
  "TXN-00004": {
    id: "TXN-00004",
    user: "Premium Hotels Group",
    email: "billing@premiumhotels.sa",
    type: "subscription",
    typeName: "Subscription Payment",
    amount: 999,
    currency: "SAR",
    method: "bank-transfer",
    methodName: "Bank Transfer - Al Rajhi",
    gateway: "Direct",
    gatewayRef: "BNK-SUB-441",
    status: "completed",
    date: "Mar 01, 2026 00:01",
    relatedId: "SUB-045",
    relatedType: "Subscription",
    commission: 0,
    commissionAmount: 0,
    netAmount: 999,
    vendorName: "Premium Hotels Group",
    vendorId: "VND-008",
    settlementStatus: "settled",
    settlementDate: "Mar 01, 2026",
    gatewayStatus: "succeeded",
    gatewayMessage: "Bank transfer confirmed",
    ip: "192.168.5.10",
    country: "Saudi Arabia",
  },
  "TXN-00005": {
    id: "TXN-00005",
    user: "Riyadh Tours Inc.",
    email: "ads@riyadhtours.com",
    type: "ads",
    typeName: "Ads Billing",
    amount: 2500,
    currency: "SAR",
    method: "credit-card",
    methodName: "Credit Card ****1122",
    gateway: "Stripe",
    gatewayRef: "ch_7XyZ1a4gBlMA9",
    status: "completed",
    date: "Mar 02, 2026 10:00",
    relatedId: "AD-018",
    relatedType: "Ad Campaign",
    commission: 0,
    commissionAmount: 0,
    netAmount: 2500,
    vendorName: "Riyadh Tours Inc.",
    vendorId: "VND-019",
    settlementStatus: "settled",
    settlementDate: "Mar 04, 2026",
    gatewayStatus: "succeeded",
    gatewayMessage: "Payment captured",
    ip: "10.10.10.5",
    country: "Saudi Arabia",
  },
  "TXN-00006": {
    ...
    currency: "SAR",
    method: "wallet",
    methodName: "Wallet Credit",
    gateway: "Internal",
    gatewayRef: "RFD-WAL-66201",
    status: "completed",
    date: "Feb 22, 2026 11:30",
    relatedId: "RFD-003",
    relatedType: "Refund",
    commission: 0,
    commissionAmount: 0,
    ...
    settlementDate: "Feb 22, 2026",
    gatewayStatus: "succeeded",
    gatewayMessage: "Wallet credit applied",
    ip: "System",
    country: "N/A",
  },
  "TXN-00007": {
    id: "TXN-00007",
    user: "Luxury Palace Hotel",
    email: "finance@luxurypalace.sa",
    type: "payout",
    typeName: "Vendor Payout",
    amount: 39600,
    currency: "SAR",
    method: "bank-transfer",
    methodName: "Bank Transfer - Al Rajhi ****4521",
    gateway: "Direct",
    gatewayRef: "PAY-2026-001",
    status: "completed",
    date: "Mar 03, 2026 08:00",
    relatedId: "PAY-001",
    relatedType: "Payout",
    commission: 0,
    commissionAmount: 0,
    ...
    settlementDate: "Mar 03, 2026",
    gatewayStatus: "succeeded",
    gatewayMessage: "Bank transfer initiated",
    ip: "System",
    country: "N/A",
  },
  "TXN-00008": {
    ...
    currency: "SAR",
    method: "credit-card",
    methodName: "Credit Card ****9156",
    gateway: "Stripe",
    gatewayRef: "ch_9AbC2d5hCnOB1",
    status: "completed",
    date: "Feb 15, 2026 18:22",
    relatedId: "BKG-1089",
    relatedType: "Booking",
    commission: 12,
    commissionAmount: 744,
    netAmount: 5456,
    vendorName: "Beach Resort & Spa",
    vendorId: "VND-028",
    settlementStatus: "settled",
    settlementDate: "Feb 18, 2026",
    gatewayStatus: "succeeded",
    gatewayMessage: "Payment processed successfully",
    ip: "88.45.12.67",
    country: "Saudi Arabia",
  ...
  "TXN-00009": {
    ...
    currency: "SAR",
    method: "credit-card",
    methodName: "Credit Card ****6789",
    gateway: "Stripe",
    gatewayRef: "ch_0DeF3e6iDoPC2",
    status: "pending",
    date: "Mar 03, 2026 20:10",
    relatedId: "BKG-1345",
    relatedType: "Booking",
    commission: 10,
    commissionAmount: 350,
    netAmount: 3150,
    vendorName: "Jeddah City Tours",
    vendorId: "VND-035",
    settlementStatus: "pending",
    settlementDate: "",
    gatewayStatus: "pending",
    gatewayMessage: "Awaiting payment confirmation",
    ip: "45.67.89.12",
    country: "Saudi Arabia",
  },
  "TXN-00010": {
    id: "TXN-00010",
    user: "Adventure Seekers Co.",
    email: "billing@adventureseekers.sa",
    type: "commission",
    typeName: "Commission Deduction",
    amount: 1850,
    currency: "SAR",
    method: "bank-transfer",
    methodName: "Auto-deduction",
    gateway: "Internal",
    gatewayRef: "COM-2026-FEB",
    status: "completed",
    date: "Mar 01, 2026 00:05",
    relatedId: "COM-FEB-2026",
    relatedType: "Monthly Commission",
    commission: 0,
    commissionAmount: 1850,
    netAmount: 0,
    vendorName: "Adventure Seekers Co.",
    vendorId: "VND-042",
    settlementStatus: "settled",
    settlementDate: "Mar 01, 2026",
    gatewayStatus: "succeeded",
    gatewayMessage: "Auto-deduction processed",
    ip: "System",
    country: "N/A",
  },
};
...
function filterTransactions() {
  const searchTerm =
    document.getElementById("transactionSearchInput")?.value.toLowerCase() ||
    "";
  const typeFilter =
  ...
  const methodFilter =
    document.getElementById("transactionMethodFilter")?.value || "all";
  ...
  rows.forEach((row) => {
    ...
    const matchesSearch =
      ...
      txn.gatewayRef.toLowerCase().includes(searchTerm);
    const matchesType = typeFilter === "all" || txn.type === typeFilter;
    const matchesStatus = statusFilter === "all" || txn.status === statusFilter;
    const matchesMethod = methodFilter === "all" || txn.method === methodFilter;
    row.style.display =
      matchesSearch && matchesType && matchesStatus && matchesMethod
        ? ""
        : "none";
  });
}
...
function populateTransactionView(txn) {
  ...
  document.getElementById("viewTxnAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(txn.id.substring(4, 9)) +
    "&background=3498db&color=fff&size=120";
  ...
  document.getElementById("viewTxnAmount").textContent =
  ...
  document.getElementById("viewTxnBooking").textContent =
    txn.relatedId + " (" + txn.relatedType + ")";
...
const notificationsData = {
  "NTF-001": {
    ...
    subject: "Exclusive Ramadan Deals - Up to 40% Off!",
  ...
  "NTF-002": {
    id: "NTF-002",
    title: "New Hotel Partner",
    subject: "Welcome Beach Resort & Spa to TourHub!",
  ...
  "NTF-003": {
    ...
    subject: "Important: Commission Rate Changes Effective April 1",
  ...
  "NTF-004": {
    ...
    subject: "Scheduled Maintenance - March 10, 2026",
    ...
    clickRate: 0,
    sentDate: "",
    scheduledDate: "Mar 08, 2026 09:00",
    channels: "Push, Email",
    pushEnabled: "yes",
    emailEnabled: "yes",
    smsEnabled: "no",
  ...
  "NTF-005": {
    ...
    subject: "Welcome to TourHub! Start Exploring",
  ...
  "NTF-007": {
    ...
    subject: "Book Summer 2026 Early & Save 25%!",
  ...
  "NTF-008": {
    ...
    clickRate: 0,
    sentDate: "",
    scheduledDate: "Mar 07, 2026 18:00",
    channels: "Push, Email, SMS",
    pushEnabled: "yes",
    emailEnabled: "yes",
    smsEnabled: "yes",
...
function filterNotifications() {
  const searchTerm =
    document.getElementById("notificationSearchInput")?.value.toLowerCase() ||
    "";
  const typeFilter =
  ...
  rows.forEach((row) => {
    ...
    const matchesSearch =
      ...
      notif.id.toLowerCase().includes(searchTerm) ||
...
function populateNotificationView(notif) {
  document.getElementById("viewNotifTitle").textContent =
  ...
  document.getElementById("viewNotifAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(notif.id.substring(0, 2)) +
    "&background=f39c12&color=fff&size=120";
  ...
  document.getElementById("viewNotifType").textContent =
    notif.type.charAt(0).toUpperCase() + notif.type.slice(1);
  document.getElementById("viewNotifTarget").textContent = notif.targetLabel;
  document.getElementById("viewNotifRecipients").textContent =
    notif.recipients > 0 ? notif.recipients.toLocaleString() : "N/A";
  document.getElementById("viewNotifSentDate").textContent =
    notif.sentDate || notif.scheduledDate || "Not sent";
  document.getElementById("viewNotifPriority").textContent =
...
const supportTicketsData = {
  "TKT-001": {
    ...
    assignedId: "agent-1",
    created: "Mar 03, 2026 14:22",
    updated: "Mar 04, 2026 09:15",
    description:
      "I made a booking for Luxury Palace Hotel (BKG-1234) yesterday but have not received any confirmation email. I checked my spam folder as well. The payment of SAR 4,500 was deducted from my card. Please help.",
    relatedBooking: "BKG-1234",
    sla: {
      responseTime: "2 hours",
      resolutionTime: "24 hours",
      firstResponse: "45 min",
      breach: false,
    },
    conversation: [
      {
        ...
        message:
          "I made a booking for Luxury Palace Hotel (BKG-1234) yesterday but have not received any confirmation email. I checked my spam folder as well. The payment of SAR 4,500 was deducted from my card. Please help.",
        time: "Mar 03, 2026 14:22",
      },
      {
        sender: "Sarah Johnson",
        role: "admin",
        message:
          "Hello Ahmed, Thank you for reaching out. I can see your booking BKG-1234 in our system. The confirmation email was sent but it appears there was a delivery issue. I am resending it now. You should receive it within 5 minutes.",
        time: "Mar 03, 2026 15:07",
      },
      {
        sender: "Ahmed Al-Rashid",
        role: "customer",
        message:
          "Thank you! I received the email now. However, the dates shown are wrong. I booked for March 15-18 but the confirmation shows March 16-19.",
        time: "Mar 04, 2026 09:15",
      },
    ],
    internalNotes:
      "Email delivery issue confirmed. Dates mismatch needs to be verified with hotel.",
  },
  "TKT-002": {
    id: "TKT-002",
    customer: "Fatima Hassan",
    ...
    assignedId: "agent-2",
    created: "Feb 28, 2026 10:30",
    updated: "Mar 04, 2026 16:45",
    description:
      "I cancelled my Umrah Package booking (BKG-1198) on Feb 25 and was told the refund would be processed in 3-5 business days. It has been 7 days and I still have not received my refund of SAR 10,800.",
    relatedBooking: "BKG-1198",
    sla: {
      responseTime: "1 hour",
      resolutionTime: "12 hours",
      firstResponse: "28 min",
      breach: true,
    },
    conversation: [
      {
        ...
        role: "customer",
        message:
          "I cancelled my Umrah Package booking (BKG-1198) on Feb 25 and was told the refund would be processed in 3-5 business days. It has been 7 days and I still have not received my refund.",
        time: "Feb 28, 2026 10:30",
      },
      {
        sender: "Mohammed Ali",
        role: "admin",
        message:
          "Hello Fatima, I apologize for the delay. Let me check the refund status for your booking. I can see that the refund was approved but the processing to your bank is pending. I am escalating this to our finance team immediately.",
        time: "Feb 28, 2026 10:58",
      },
      {
        sender: "Mohammed Ali",
        role: "admin",
        message:
          "Update: The refund of SAR 10,800 has been re-initiated. You should see it in your account within 2-3 business days. I have marked this as priority.",
        time: "Mar 02, 2026 11:00",
      },
      {
        sender: "Fatima Hassan",
        role: "customer",
        message:
          "It is March 4th now and I still have not received the refund. This is unacceptable. I want to speak to a manager.",
        time: "Mar 04, 2026 16:45",
      },
    ],
    internalNotes:
      "ESCALATED: Refund stuck in payment gateway. Finance team investigating. Customer very upset.",
  },
  "TKT-003": {
    id: "TKT-003",
    customer: "Omar Khalid",
    ...
    assignedId: "agent-3",
    created: "Mar 01, 2026 08:15",
    updated: "Mar 01, 2026 12:30",
    description:
      'I cannot login to my account. It keeps showing "Invalid credentials" even though I am sure my password is correct. I tried the forgot password option but did not receive any reset email.',
    relatedBooking: "",
    sla: {
      responseTime: "4 hours",
      resolutionTime: "48 hours",
      firstResponse: "1 hr 10 min",
      breach: false,
    },
    conversation: [
      {
        ...
        role: "customer",
        message:
          'I cannot login to my account. It keeps showing "Invalid credentials" even though I am sure my password is correct.',
        time: "Mar 01, 2026 08:15",
      },
      {
        sender: "Fatima Ahmed",
        role: "admin",
        message:
          "Hello Omar, I have checked your account and it appears your email was updated recently. Please try logging in with omar.khalid@example.com. I have also sent a password reset link to both your emails.",
        time: "Mar 01, 2026 09:25",
      },
      {
        sender: "Omar Khalid",
        role: "customer",
        message:
          "That worked! I was able to reset my password and login. Thank you for the quick help!",
        time: "Mar 01, 2026 12:30",
      },
    ],
    internalNotes:
      "Email update caused login confusion. Resolved with password reset.",
  },
  "TKT-004": {
    id: "TKT-004",
    customer: "Sara Al-Mutairi",
    ...
    assignedTo: "Sarah Johnson",
    assignedId: "agent-1",
    created: "Mar 02, 2026 20:10",
    updated: "Mar 03, 2026 10:00",
    description:
      "I booked an Ocean View room at Beach Resort & Spa but was given a city view room instead. The hotel says they do not have availability for ocean view. I paid extra specifically for the ocean view. This is misleading.",
    relatedBooking: "BKG-1089",
    sla: {
      responseTime: "2 hours",
      resolutionTime: "24 hours",
      firstResponse: "1 hr 50 min",
      breach: false,
    },
    conversation: [
      {
        sender: "Sara Al-Mutairi",
        role: "customer",
        message:
          "I booked an Ocean View room at Beach Resort & Spa but was given a city view room instead. This is misleading advertising.",
        time: "Mar 02, 2026 20:10",
      },
      {
        sender: "Sarah Johnson",
        role: "admin",
        message:
          "Hello Sara, I sincerely apologize for this experience. I am contacting Beach Resort & Spa right now to resolve this. We will either get you the correct room or arrange appropriate compensation.",
        time: "Mar 02, 2026 22:00",
      },
    ],
    internalNotes:
      "Contacted hotel. They confirmed overbooking issue. Negotiating upgrade or partial refund.",
  },
  "TKT-005": {
    id: "TKT-005",
    customer: "Khalid Al-Dosari",
    ...
    assignedId: "agent-4",
    created: "Mar 04, 2026 15:30",
    updated: "Mar 04, 2026 15:30",
    description:
      'I tried to book Jeddah City Tour and the payment page showed "Payment Failed" but SAR 3,500 was deducted from my credit card. I do not see any booking in my account. Please refund immediately.',
    relatedBooking: "",
    sla: {
      responseTime: "1 hour",
      resolutionTime: "12 hours",
    ...
    conversation: [
      {
        sender: "Khalid Al-Dosari",
        role: "customer",
        message:
          'I tried to book Jeddah City Tour and the payment page showed "Payment Failed" but SAR 3,500 was deducted from my credit card. Please refund immediately.',
        time: "Mar 04, 2026 15:30",
      },
    ],
    internalNotes: "",
  },
  "TKT-006": {
    ...
    assignedTo: "Fatima Ahmed",
    assignedId: "agent-3",
    created: "Feb 26, 2026 13:00",
    updated: "Feb 26, 2026 14:30",
    description:
      "Hi, I would like to change the dates of my Mountain View Lodge booking from March 10-13 to March 17-20. Is this possible? How do I do it?",
    ...
    conversation: [
      {
        sender: "Nora Al-Harbi",
        role: "customer",
        message:
          "I would like to change the dates of my Mountain View Lodge booking from March 10-13 to March 17-20. Is this possible?",
        time: "Feb 26, 2026 13:00",
      },
      {
        sender: "Fatima Ahmed",
        role: "admin",
        message:
          "Hello Nora, Yes, you can change your booking dates. Go to My Bookings > BKG-1401 > Modify Booking. If the new dates are available, the change will be processed. There is no extra charge for date changes made more than 7 days before check-in.",
        time: "Feb 26, 2026 13:45",
      },
      {
        sender: "Nora Al-Harbi",
        role: "customer",
        message: "Perfect, I was able to change it. Thank you!",
        time: "Feb 26, 2026 14:30",
      },
    ],
...
function populateSupportTable() {
  ...
  for (let id in supportTicketsData) {
    ...
    const statusClass =
      "status-" + ticket.status.replace("in-progress", "in-progress");
...
function setupSupportFilters() {
  ...
  if (categoryFilter)
    categoryFilter.addEventListener("change", filterSupportTickets);
}

function filterSupportTickets() {
  const searchTerm =
    document.getElementById("supportSearchInput")?.value.toLowerCase() || "";
  const statusFilter =
    document.getElementById("supportStatusFilter")?.value || "all";
  const priorityFilter =
    document.getElementById("supportPriorityFilter")?.value || "all";
  const categoryFilter =
    document.getElementById("supportCategoryFilter")?.value || "all";
...
function populateSupportView(ticket) {
  document.getElementById("viewTicketTitle").textContent =
    "Ticket " + ticket.id;
  ...
  document.getElementById("viewTicketAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(ticket.id.substring(0, 2)) +
    "&background=9b59b6&color=fff&size=120";
  ...
  document.getElementById("viewTicketCategory").textContent =
    ticket.category.charAt(0).toUpperCase() + ticket.category.slice(1);
  document.getElementById("viewTicketPriority").innerHTML =
...
function initializeSupportEditPage() {
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      e.preventDefault();
      setTimeout(function () {
        window.location.href = "support-view.html?id=" + ticketId;
      }, 1000);
    });
  }
...
function populateSupportEdit(ticket) {
  ...
  document.getElementById("editTicketCustomerDisplay").textContent =
    ticket.customer;
  document.getElementById("editTicketCategoryDisplay").textContent =
    ticket.category.charAt(0).toUpperCase() + ticket.category.slice(1);
  document.getElementById("editTicketCreatedDisplay").textContent =
    ticket.created;
  ...
  document.getElementById("editTicketInternalNotes").value =
...
const cmsPagesData = {
  ...
  "CMS-005": {
    ...
    metaDesc:
      "Get in touch with TourHub support team. Find our contact details, office address, and customer service hours.",
    keywords: "contact, support, phone, email, address, help",
    content:
      "<h2>Contact Us</h2><p>We are here to help! Reach out to us through any of the channels below.</p><h3>Customer Support</h3><p>Email: support@tourhub.com<br>Phone: +966 11 234 5678<br>WhatsApp: +966 50 123 4567<br>Hours: 24/7</p><h3>Head Office</h3><p>TourHub Arabia Ltd.<br>King Fahd Road<br>Riyadh, Saudi Arabia 11564</p><h3>Business Inquiries</h3><p>Email: business@tourhub.com<br>Phone: +966 11 234 5679</p>",
    versions: [
      {
        version: "v1.1",
        date: "Feb 10, 2026",
        editor: "Admin User",
        note: "Updated phone numbers",
      },
      {
        version: "v1.0",
        date: "Jan 20, 2026",
  ...
  "CMS-008": {
    ...
    content:
      "<h2>Safety Tips for Travelers</h2><p>Draft content - safety guidelines and tips for travelers visiting Saudi Arabia.</p>",
    versions: [
      {
        version: "v0.1",
        date: "Mar 01, 2026",
...
function filterCmsPages() {
  const searchTerm =
    document.getElementById("cmsSearchInput")?.value.toLowerCase() || "";
  const statusFilter =
    document.getElementById("cmsStatusFilter")?.value || "all";
...
function populateCmsView(page) {
  ...
  document.getElementById("viewCmsAvatar").src =
    "https://ui-avatars.com/api/?name=" +
    encodeURIComponent(page.title.substring(0, 2)) +
    "&background=1abc9c&color=fff&size=120";
  ...
  document.getElementById("viewCmsType").textContent =
  ...
  if (contentEl) {
    contentEl.innerHTML =
      '<div class="cms-content-preview">' + page.content + "</div>";
  }
...
function populateCmsEdit(page) {
  ...
  document.getElementById("editCmsBody").value = page.content
    .replace(/<[^>]*>/g, "\n")
    .replace(/\n{2,}/g, "\n\n")
    .trim();
  ...
  const loginHistory = [
    {
      ...
      time: "Mar 05, 2026 09:42 AM",
    },
    {
      action: "Login successful",
      ip: "92.168.1.45",
      device: "Chrome on Windows",
      time: "Mar 04, 2026 08:30 AM",
    },
    {
      action: "Password changed",
      ip: "92.168.1.45",
      device: "Chrome on Windows",
      time: "Mar 03, 2026 14:15 PM",
    },
    {
      action: "Login successful",
      ip: "10.0.0.88",
      device: "Safari on macOS",
      time: "Mar 03, 2026 08:22 AM",
    },
    {
      action: "Failed login attempt",
      ip: "45.67.89.12",
      device: "Firefox on Linux",
      time: "Mar 02, 2026 23:45 PM",
    },
    {
      action: "Login successful",
      ip: "92.168.1.45",
      device: "Chrome on Windows",
      time: "Mar 02, 2026 08:15 AM",
    },
    {
      action: "2FA enabled",
      ip: "92.168.1.45",
      device: "Chrome on Windows",
      time: "Mar 01, 2026 16:30 PM",
    },
    {
      action: "Login successful",
      ip: "92.168.1.45",
      device: "Chrome on Windows",
      time: "Mar 01, 2026 08:00 AM",
    },
  ];

  let html = "";
  loginHistory.forEach((entry) => {
    const icon = entry.action.includes("Failed")
      ? "fa-exclamation-triangle"
      : entry.action.includes("Password")
        ? "fa-key"
        : entry.action.includes("2FA")
          ? "fa-shield-alt"
          : "fa-sign-in-alt";
...
function initializeDateFilter() {
  ...
  quickOptions.forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      quickOptions.forEach(function (b) {
  ...
  function closeRangePicker() {
    ...
    const customOption = dateFilter
      ? dateFilter.querySelector('option[value="custom"]')
      : null;
        ...
        datasets: [
          {
            label: "Revenue ($)",
            data: [
              12000, 15000, 18000, 22000, 25000, 28000, 31000, 35000, 32000,
              38000, 42000, 48000,
            ],
            borderColor: "#16a085",
          ...
          },
          {
            label: "Commission ($)",
            data: [
              1200, 1500, 1800, 2200, 2500, 2800, 3100, 3500, 3200, 3800, 4200,
              4800,
            ],
            borderColor: "#e67e22",
...
var vendorsData = {
  "VND-001": {
    ...
    owner: "Abdulaziz Al-Faisal",
    email: "info@alfaisaliah.com",
    ...
    avatar: "Al+Faisaliah+Hotel",
    avatarBg: "667eea",
    responseTime: "2.3 hours",
    cancelRate: "1.8%",
    payout: "Monthly",
    totalPayouts: "$215,600",
    description:
      "Luxury 5-star hotel located in the heart of Riyadh, offering premium accommodation and world-class dining experiences.",
    bankName: "Al Rajhi Bank",
  ...
  "VND-002": {
    ...
    totalPayouts: "$80,550",
    description:
      "Authentic Saudi Arabian restaurant serving traditional Najd cuisine with modern presentation.",
    bankName: "Saudi National Bank",
    accountNumber: "SA44 1000 0000 0060 8010 1234",
    notes:
      "Excellent customer reviews. Featured vendor for dining experiences.",
  },
  "VND-003": {
    name: "Desert Adventures",
    owner: "Turki Al-Otaibi",
    email: "info@desertadventures.sa",
    phone: "+966 50 789 0123",
    joined: "Jul 22, 2025",
    status: "Pending",
    type: "tour",
    typeName: "Tour Operator",
    typeIcon: "fa-compass",
    rating: "N/A",
    revenue: "$0",
    commission: "—",
    ...
    totalPayouts: "$0",
    description:
      "Desert safari and outdoor adventure tour operator specializing in cultural desert experiences.",
    bankName: "Riyad Bank",
    accountNumber: "SA22 2000 0000 0012 3456 7890",
    notes:
      "New application. Documents under review. Awaiting insurance verification.",
  },
  "VND-004": {
    name: "Red Sea Resort",
    owner: "Omar Al-Harbi",
    email: "reservations@redsearesort.com",
    ...
    bookings: "1,892",
    location: "Jeddah, KSA",
    website: "www.redsearesort.com",
    avatar: "Red+Sea+Resort",
    avatarBg: "e74c3c",
    responseTime: "1.8 hours",
    cancelRate: "1.2%",
    payout: "Monthly",
    totalPayouts: "$265,880",
    description:
      "Beachfront luxury resort on the Red Sea coast with private beach, spa, and premium water sports facilities.",
    bankName: "Al Rajhi Bank",
    accountNumber: "SA55 8000 0000 6123 4567 8901",
    notes:
      "Top-performing vendor. Consistently high ratings. Premium partnership tier.",
  },
  "VND-005": {
    name: "Jeddah Rides",
    owner: "Faisal Mahmoud",
    email: "support@jeddahrides.com",
    ...
    totalPayouts: "$0",
    description:
      "Private car hire and airport transfer service operating across Jeddah and surrounding areas.",
    bankName: "Saudi National Bank",
    accountNumber: "SA66 1000 0000 0078 9012 3456",
    notes: "New application. Fleet verification in progress.",
  },
  "VND-006": {
    name: "Arabian Nights Dining",
    owner: "Noura Al-Saud",
    email: "hello@arabiannightsdining.com",
    ...
    bookings: "612",
    location: "Riyadh, KSA",
    website: "www.arabiannightsdining.com",
    avatar: "Arabian+Nights+Dining",
    avatarBg: "16a085",
    ...
    totalPayouts: "$60,480",
    description:
      "Themed dining experience with traditional Arabian ambiance, live entertainment, and authentic Middle Eastern cuisine.",
    bankName: "Alinma Bank",
  ...
  "VND-007": {
    ...
    totalPayouts: "$0",
    description:
      "Mountain trekking and hiking tours in the Asir region, specializing in guided outdoor adventures.",
    bankName: "Riyad Bank",
  ...
  "VND-008": {
    ...
    owner: "Salman Al-Dosari",
    email: "info@riyadhgrandhotel.com",
    ...
    bookings: "943",
    location: "Riyadh, KSA",
    website: "www.riyadhgrandhotel.com",
    avatar: "Riyadh+Grand+Hotel",
    avatarBg: "4facfe",
    responseTime: "5.2 hours",
    cancelRate: "4.1%",
    payout: "Monthly",
    totalPayouts: "$137,632",
    description:
      "Budget-friendly hotel in central Riyadh, disabled due to ongoing quality improvement measures.",
    bankName: "Al Rajhi Bank",
    accountNumber: "SA99 8000 0000 6234 5678 9012",
    notes:
      "Disabled due to multiple customer complaints about room quality. Under review for potential reinstatement after improvements.",
  },
};
...
function initializeVendorActions() {
  // Approve buttons
  document
    .querySelectorAll("#vendorsTable .action-approve")
    .forEach(function (btn) {
      btn.addEventListener("click", function () {
  ...
  // Reject buttons
  document
    .querySelectorAll("#vendorsTable .action-reject")
    .forEach(function (btn) {
      btn.addEventListener("click", function () {
        var row = this.closest("tr");
        var statusBadge = row.querySelector(".status-badge");
...
function initializeVendorViewPage() {
  ...
  if (vendor) {
    document.getElementById("viewVendorAvatar").src =
      "https://ui-avatars.com/api/?name=" +
      vendor.avatar +
      "&background=" +
      vendor.avatarBg +
    ...
    document.getElementById("viewVendorTotalPayouts").textContent =
      vendor.totalPayouts;
    ...
    if (typeBadge) {
      ...
      typeBadge.innerHTML =
        '<i class="fas ' + vendor.typeIcon + '"></i> ' + vendor.typeName;
    }
...
function initializeVendorEditPage() {
  ...
  if (vendor) {
    document.getElementById("editVendorAvatar").src =
      "https://ui-avatars.com/api/?name=" +
      vendor.avatar +
      "&background=" +
      vendor.avatarBg +
    ...
    if (websiteInput) {
      websiteInput.value = vendor.website.startsWith("http")
        ? vendor.website
...
var providersData = {
  "SPR-001": {
    name: "Saudi Tours Co",
    contact: "Mansour Al-Harbi",
    email: "info@sauditours.com",
    phone: "+966 11 345 6789",
    joined: "Mar 15, 2025",
    status: "Approved",
    type: "package",
    typeName: "Package Provider",
    typeIcon: "fa-suitcase-rolling",
    rating: "4.9",
    revenue: "$467,500",
    commission: "15",
    bookings: "2,845",
    area: "Riyadh, Jeddah, Mecca",
    website: "www.sauditours.com",
    avatar: "Saudi+Tours+Co",
    avatarBg: "667eea",
    ...
    satisfaction: "96%",
    description:
      "Premium tour package provider specializing in desert safaris, cultural heritage tours, and adventure activities across Saudi Arabia.",
    bankName: "Al Rajhi Bank",
    accountNumber: "SA03 8000 0000 6080 1016 7519",
    notes:
      "Top-performing provider. Premium partner with excellent customer satisfaction scores. Subscription auto-renews annually.",
  },
  "SPR-002": {
    name: "Adventure Arabia",
    contact: "Yusuf Al-Qahtani",
    email: "hello@adventurearabia.com",
    phone: "+966 50 456 7890",
    joined: "Apr 20, 2025",
    status: "Approved",
    type: "activity",
    typeName: "Activity Operator",
    typeIcon: "fa-hiking",
    rating: "4.7",
    revenue: "$234,200",
    commission: "12",
    bookings: "1,623",
    area: "Riyadh, AlUla, Abha",
    website: "www.adventurearabia.com",
    avatar: "Adventure+Arabia",
    avatarBg: "27ae60",
    ...
    satisfaction: "93%",
    description:
      "Outdoor adventure and activity operator offering hiking, rock climbing, zip-lining, and desert camping experiences.",
    bankName: "Saudi National Bank",
    accountNumber: "SA44 1000 0000 0060 8010 1234",
    notes:
      "Strong activity operator. Growing customer base. Consider for premium tier upgrade.",
  },
  "SPR-003": {
    name: "Heritage Guides",
    contact: "Nasser Al-Shammari",
    email: "contact@heritageguides.sa",
    phone: "+966 11 789 0123",
    joined: "Jul 10, 2025",
    status: "Pending",
    type: "guide",
    typeName: "Guide Service",
    ...
    satisfaction: "N/A",
    description:
      "Cultural heritage guide service specializing in historic site tours, museum guides, and educational experiences.",
    bankName: "Riyad Bank",
    accountNumber: "SA22 2000 0000 0012 3456 7890",
    notes:
      "New application. Documents under review. Guide certifications pending verification.",
  },
  "SPR-004": {
    name: "Royal Experiences",
    contact: "Sultan Al-Dosari",
    email: "info@royalexperiences.com",
    phone: "+966 11 654 3210",
    joined: "Feb 01, 2025",
    status: "Approved",
    type: "experience",
    typeName: "Experience Host",
    typeIcon: "fa-gem",
    rating: "4.8",
    revenue: "$389,700",
    commission: "18",
    bookings: "2,156",
    area: "Riyadh, Jeddah, NEOM",
    website: "www.royalexperiences.com",
    avatar: "Royal+Experiences",
    avatarBg: "e74c3c",
    subscription: "premium",
    subscriptionName: "Premium",
    billing: "Annual",
    ...
    satisfaction: "98%",
    description:
      "Luxury experience host offering exclusive VIP tours, private dining, helicopter tours, and bespoke cultural experiences.",
    bankName: "Al Rajhi Bank",
    accountNumber: "SA55 8000 0000 6123 4567 8901",
    notes:
      "Top-tier partner. Highest satisfaction scores. Exclusive luxury experiences. VIP partnership.",
  },
  "SPR-005": {
    name: "Oasis Expeditions",
    contact: "Tariq Al-Mutairi",
    email: "tours@oasisexpeditions.com",
    ...
    commission: "10",
    bookings: "456",
    area: "Eastern Province, Dammam",
    website: "www.oasisexpeditions.com",
    avatar: "Oasis+Expeditions",
    avatarBg: "9b59b6",
    subscription: "basic",
    ...
    satisfaction: "87%",
    description:
      "Tour package provider focusing on Eastern Province experiences, oil heritage tours, and coastal adventures.",
    bankName: "Alinma Bank",
  ...
  "SPR-006": {
    ...
    contact: "Bader Al-Enazi",
    email: "info@falconadventures.sa",
    ...
    commission: "12",
    bookings: "1,089",
    area: "Tabuk, AlUla, Asir",
    website: "www.falconadventures.sa",
    avatar: "Falcon+Adventures",
    avatarBg: "16a085",
    subscription: "standard",
    subscriptionName: "Standard",
    billing: "Quarterly",
    ...
    satisfaction: "91%",
    description:
      "Adventure activity operator offering falconry experiences, desert trekking, sandboarding, and stargazing tours.",
    bankName: "Saudi National Bank",
    accountNumber: "SA77 1000 0000 0078 9012 3456",
    notes:
      "Reliable activity operator. Good seasonal performance. Consider expanding service areas.",
  },
  "SPR-007": {
    name: "Nomad Trails",
    contact: "Saleh Al-Ghamdi",
    email: "info@nomadtrails.sa",
    ...
    satisfaction: "72%",
    description:
      "Mountain trail guide service in the Asir region. Currently suspended pending performance review.",
    bankName: "Riyad Bank",
    accountNumber: "SA88 2000 0000 0045 6789 0123",
    notes:
  ...
  "SPR-008": {
    ...
    contact: "Hamad Al-Wahabi",
    email: "contact@pearldivingtours.com",
    ...
    satisfaction: "N/A",
    description:
      "Unique pearl diving experience host offering traditional pearl harvesting tours and marine cultural experiences.",
    bankName: "Al Rajhi Bank",
    accountNumber: "SA99 8000 0000 6234 5678 9012",
    notes:
      "New application. Awaiting document verification and safety certification review.",
  },
};
...
function initializeProviderActions() {
  // Approve buttons
  document
    .querySelectorAll("#providersTable .action-approve")
    .forEach(function (btn) {
      btn.addEventListener("click", function () {
        var row = this.closest("tr");
        var statusBadge = row.querySelector(".status-badge");
  ...
  // Reject buttons
  document
    .querySelectorAll("#providersTable .action-reject")
    .forEach(function (btn) {
      btn.addEventListener("click", function () {
        var row = this.closest("tr");
        var statusBadge = row.querySelector(".status-badge");
...
function initializeProviderViewPage() {
  ...
  if (provider) {
    document.getElementById("viewProviderAvatar").src =
      "https://ui-avatars.com/api/?name=" +
      provider.avatar +
      "&background=" +
      provider.avatarBg +
    ...
    document.getElementById("viewProviderContact").textContent =
      provider.contact;
    ...
    document.getElementById("viewProviderWebsite").textContent =
      provider.website;
    document.getElementById("viewProviderJoined").textContent = provider.joined;
    document.getElementById("viewProviderBookings").textContent =
      provider.bookings;
    document.getElementById("viewProviderRevenue").textContent =
      provider.revenue;
    ...
    document.getElementById("viewProviderBilling").textContent =
      provider.billing;
    document.getElementById("viewProviderRenewal").textContent =
      provider.renewal;
    document.getElementById("viewProviderFee").textContent = provider.fee;

    // Performance metrics
    document.getElementById("viewProviderResponseTime").textContent =
      provider.responseTime;
    document.getElementById("viewProviderCancelRate").textContent =
      provider.cancelRate;
    document.getElementById("viewProviderCompletionRate").textContent =
      provider.completionRate;
    document.getElementById("viewProviderSatisfaction").textContent =
    ...
    statusEl.className =
      "status-badge status-" + provider.status.toLowerCase().replace(" ", "-");
    ...
    if (typeBadge) {
      ...
      typeBadge.innerHTML =
        '<i class="fas ' + provider.typeIcon + '"></i> ' + provider.typeName;
    }
    ...
    if (suspendBtn) {
      if (provider.status === "Suspended") {
        suspendBtn.innerHTML =
          '<i class="fas fa-check-circle"></i> Reinstate Provider';
...
function initializeProviderEditPage() {
  ...
  if (provider) {
    document.getElementById("editProviderAvatar").src =
      "https://ui-avatars.com/api/?name=" +
      provider.avatar +
      "&background=" +
      provider.avatarBg +
      "&color=fff&size=120";
    document.getElementById("editProviderDisplayName").textContent =
      provider.name;
    ...
    document.getElementById("editProviderJoinedDisplay").value =
      provider.joined;
    ...
    if (websiteInput) {
      websiteInput.value = provider.website.startsWith("http")
        ? provider.website
...
var categoriesData = {
  "CAT-001": {
    ...
    visibility: "Public",
    description:
      "Hotels and accommodation listings including resorts, boutique hotels, and budget stays",
    reqFields: "12",
    optFields: "8",
    photoLimit: "20",
    priceModel: "Per Night",
    minPrice: "50",
    maxPrice: "10000",
    minRating: "3.5",
    responseSLA: "4",
    guidelines:
      "All listings must provide accurate amenity information. Room sizes must be listed in square meters. Check-in/check-out times must be clearly stated. Free cancellation period of at least 24 hours is recommended.",
  },
  "CAT-002": {
    name: "Restaurants",
    slug: "restaurants",
    ...
    visibility: "Public",
    description:
      "Restaurant and dining experience listings including fine dining, cafes, and street food vendors",
    reqFields: "10",
    optFields: "6",
    photoLimit: "15",
    ...
    responseSLA: "2",
    guidelines:
      "Menu must be uploaded with current prices. Halal certification required. Dietary options (vegetarian, vegan, gluten-free) should be clearly marked. Reservation capacity must be accurate.",
  },
  "CAT-003": {
    name: "Packages",
    slug: "packages",
    ...
    visibility: "Public",
    description:
      "Tour packages and bundled travel experiences including multi-day tours and all-inclusive deals",
    reqFields: "15",
    optFields: "10",
    photoLimit: "25",
    priceModel: "Per Person",
    ...
    responseSLA: "4",
    guidelines:
      "Package itinerary must be detailed day-by-day. All inclusions and exclusions must be clearly listed. Guide languages must be specified. Safety equipment and insurance details required for adventure packages.",
  },
  "CAT-004": {
    name: "Activities",
    slug: "activities",
    icon: "fa-hiking",
    iconGradient: "gradient-pink",
    status: "Active",
    listings: "245",
    vendors: "98",
    revenue: "$545K",
    ...
    visibility: "Public",
    description:
      "Individual activities and experiences including adventure sports, cultural activities, and wellness",
    reqFields: "11",
    optFields: "7",
    photoLimit: "15",
    priceModel: "Per Person",
    ...
    responseSLA: "3",
    guidelines:
      "Activity duration and difficulty level must be specified. Age restrictions and physical requirements must be listed. Safety certifications required for adventure activities. Weather cancellation policy must be defined.",
  },
  "CAT-005": {
    name: "Cabs",
    slug: "cabs",
    ...
    visibility: "Public",
    description:
      "Transportation and cab services including airport transfers, city tours, and inter-city rides",
    reqFields: "8",
    optFields: "5",
    photoLimit: "10",
    priceModel: "Per Kilometer",
    minPrice: "5",
    maxPrice: "1000",
    minRating: "3.0",
    responseSLA: "1",
    guidelines:
      "Vehicle type and capacity must be specified. Driver credentials and license verification required. GPS tracking must be enabled. Base fare and per-km rate must be transparent.",
  },
  "CAT-006": {
    name: "Wellness & Spa",
    slug: "wellness-spa",
    ...
    visibility: "Public",
    description:
      "Wellness, spa, and relaxation services including massage, traditional hammam, and health retreats",
    reqFields: "9",
    optFields: "6",
    photoLimit: "15",
    priceModel: "Per Person",
    ...
    responseSLA: "3",
    guidelines:
      "Practitioner qualifications must be listed. Treatment durations and descriptions required. Health disclaimers and contraindications must be stated. Hygiene certification required.",
  },
  "CAT-007": {
    name: "Cruises",
    slug: "cruises",
    ...
    visibility: "Public",
    description:
      "Cruise and boat tour experiences including Red Sea cruises, yacht charters, and fishing trips",
    reqFields: "14",
    optFields: "8",
    photoLimit: "20",
    priceModel: "Per Person",
    ...
    responseSLA: "6",
    guidelines:
      "Maritime safety certification required. Life jacket availability must be confirmed. Route and port details must be specified. Sea-sickness policy and medical facilities must be listed.",
  },
  "CAT-008": {
    name: "Camping",
    slug: "camping",
    ...
    visibility: "Private",
    description:
      "Camping and glamping experiences including desert camps, mountain camping, and eco-lodges",
    reqFields: "10",
    optFields: "7",
    photoLimit: "15",
    priceModel: "Per Night",
    ...
    responseSLA: "4",
    guidelines:
      "Campsite facilities must be listed (restrooms, showers, electricity). Fire safety measures required. Wildlife warning notices must be provided. Check-in/check-out procedures for remote sites must be clearly documented.",
  },
};
...
function initializeCategoryViewPage() {
  ...
  if (category) {
    ...
    document.getElementById("viewCategoryDesc").textContent =
      category.description;
    document.getElementById("viewCategoryCreated").textContent =
      category.created;
    document.getElementById("viewCategoryOrder").textContent = category.order;
    document.getElementById("viewCategoryVisibility").textContent =
      category.visibility;
    ...
    // Stats
    document.getElementById("viewCategoryListings").textContent =
      category.listings;
    document.getElementById("viewCategoryVendors").textContent =
      category.vendors;
    document.getElementById("viewCategoryRevenue").textContent =
      category.revenue;
    document.getElementById("viewCategoryBookings").textContent =
      category.bookings;

    // Listing structure
    document.getElementById("viewCategoryReqFields").textContent =
      category.reqFields;
    document.getElementById("viewCategoryOptFields").textContent =
      category.optFields;
    document.getElementById("viewCategoryPhotoLimit").textContent =
      category.photoLimit + " photos";
    document.getElementById("viewCategoryPriceModel").textContent =
      category.priceModel;
...
function initializeCategoryEditPage() {
  ...
  if (category) {
    document.getElementById("editCategoryDisplayName").textContent =
      category.name;
    ...
    document.getElementById("editCategoryCreatedDisplay").value =
      category.created;
    document.getElementById("editCategoryGuidelines").value =
      category.guidelines;
    ...
    // Listing structure
    document.getElementById("editCategoryPhotoLimit").value =
      category.photoLimit;
    ...
    document.getElementById("editCategoryResponseSLA").value =
      category.responseSLA;
...
var commissionData = {
  "COM-001": {
    ...
    status: "active",
    totalCollected: "SAR 54,200",
    minCommission: "SAR 50",
    maxCommission: "SAR 5,000",
    overrideType: "Per-Vendor Override",
    platformFee: "Yes",
    ...
    history: [
      ...
      },
      {
        ...
        newRate: "10%",
        changedBy: "Admin User",
        reason: "Performance tier upgrade",
      },
    ],
    invoices: [
      {
  ...
  "COM-002": {
    id: "COM-002",
    vendor: "Arabian Bites Restaurant",
    vendorId: "#VND-022",
    vendorType: "Restaurant",
    commissionType: "Percentage",
    rate: "15%",
    ...
    status: "active",
    totalCollected: "SAR 28,500",
    minCommission: "SAR 30",
    maxCommission: "SAR 2,000",
    overrideType: "Default Rate",
    platformFee: "Yes",
    invoice: "Automatic - Monthly",
    modifiedBy: "Admin User",
    baseRate: "15%",
  ...
  "COM-003": {
    id: "COM-003",
    vendor: "Desert Adventures Co.",
    vendorId: "#VND-035",
    vendorType: "Package Provider",
    ...
    status: "active",
    totalCollected: "SAR 42,100",
    minCommission: "SAR 100",
    maxCommission: "SAR 10,000",
    overrideType: "Tiered Override",
    platformFee: "Yes",
    invoice: "Automatic - Weekly",
    modifiedBy: "Admin User",
    baseRate: "10%",
    avatar: "COM",
    avatarBg: "27ae60",
    history: [
      {
        ...
        newRate: "8-15%",
        changedBy: "Admin User",
        reason: "Switched to tiered commission model",
      },
    ],
    invoices: [
      {
  ...
  "COM-004": {
    id: "COM-004",
    vendor: "Jeddah Seaside Resort",
    vendorId: "#VND-008",
    vendorType: "Hotel",
    commissionType: "Fixed",
    rate: "SAR 500/booking",
    rateValue: 500,
    effectiveDate: "Mar 01, 2026",
    expiryDate: "Aug 31, 2026",
    status: "active",
    totalCollected: "SAR 18,000",
    minCommission: "SAR 500",
    maxCommission: "SAR 500",
    overrideType: "Per-Vendor Override",
    platformFee: "No",
    invoice: "Manual",
    modifiedBy: "Admin User",
    ...
    history: [
      {
        ...
        newRate: "SAR 500",
        changedBy: "Admin User",
        reason: "Negotiated fixed rate per agreement",
      },
    ],
    invoices: [
      {
  ...
  "COM-005": {
    id: "COM-005",
    vendor: "Mountain Trek Tours",
    vendorId: "#VND-041",
    vendorType: "Activity Operator",
    commissionType: "Percentage",
    rate: "10%",
    rateValue: 10,
    ...
    status: "active",
    totalCollected: "SAR 15,800",
    minCommission: "SAR 20",
    maxCommission: "SAR 3,000",
    overrideType: "Default Rate",
    platformFee: "Yes",
    invoice: "Automatic - Monthly",
    modifiedBy: "Admin User",
  ...
  "COM-006": {
    id: "COM-006",
    vendor: "Quick Ride Cabs",
    vendorId: "#VND-052",
    vendorType: "Cab Provider",
    commissionType: "Percentage",
    rate: "18%",
    rateValue: 18,
    effectiveDate: "Jan 01, 2026",
    ...
    history: [
      {
        ...
        newRate: "18%",
        changedBy: "Admin User",
        reason: "Annual cab commission adjustment",
      },
    ],
    invoices: [
      {
...
function initializeCommissionManagement() {
  ...
  if (vendorTypeFilter)
    vendorTypeFilter.addEventListener("change", filterCommissionTable);
  if (statusFilter)
    statusFilter.addEventListener("change", filterCommissionTable);
  initializeLogout();
}
...
function populateCommissionTable() {
  ...
  Object.keys(commissionData).forEach(function (key) {
    ...
    tbody.innerHTML +=
      ...
      c.id +
      "</strong></td>" +
      '<td><div class="table-user"><img src="https://ui-avatars.com/api/?name=' +
      c.avatar +
      "&background=" +
      c.avatarBg +
      '&color=fff&size=32" alt=""><div class="table-user-info"><span class="table-user-name">' +
      c.vendor +
      '</span><span class="table-user-id">' +
      c.vendorId +
      "</span></div></div></td>" +
      '<td><span class="commission-vendor-type">' +
      c.vendorType +
      "</span></td>" +
      '<td><span class="commission-type-badge commission-type-' +
      c.commissionType.toLowerCase() +
      '">' +
      c.commissionType +
      "</span></td>" +
      "<td><strong>" +
      ...
      '<a href="commission-view.html?id=' +
      c.id +
      '" class="action-btn action-view" title="View"><i class="fas fa-eye"></i></a>' +
      '<a href="commission-edit.html?id=' +
      c.id +
      '" class="action-btn action-edit" title="Edit"><i class="fas fa-pen"></i></a>' +
      "</div></td>" +
      "</tr>";
  });
}
...
function filterCommissionTable() {
  var searchTerm = (
    document.getElementById("commissionSearchInput").value || ""
  ).toLowerCase();
  var typeFilter =
    document.getElementById("commissionTypeFilter").value || "all";
  var vendorTypeFilter =
    document.getElementById("commissionVendorTypeFilter").value || "all";
  var statusFilter =
    document.getElementById("commissionStatusFilter").value || "all";
  ...
  rows.forEach(function (row) {
    ...
    var matchVendor =
      ...
      text.toLowerCase().indexOf(vendorTypeFilter) > -1;
    var matchStatus =
      statusFilter === "all" ||
      row.querySelector(".status-badge").textContent.toLowerCase() ===
        statusFilter;
    row.style.display =
      matchSearch && matchType && matchVendor && matchStatus ? "" : "none";
  });
}
...
function initializeCommissionViewPage() {
  ...
  document.getElementById("viewCommissionVendorType").textContent =
    c.vendorType;
  document.getElementById("viewCommissionStatus").textContent =
    c.status.charAt(0).toUpperCase() + c.status.slice(1);
  document.getElementById("viewCommissionStatus").className =
  ...
  document.getElementById("viewCommissionEffectiveDate").textContent =
    c.effectiveDate;
  document.getElementById("viewCommissionExpiryDate").textContent =
    c.expiryDate;
  document.getElementById("viewCommissionTotalCollected").textContent =
    c.totalCollected;
  document.getElementById("viewCommissionModifiedBy").textContent =
    c.modifiedBy;
  document.getElementById("viewCommissionBaseRate").textContent = c.baseRate;
  document.getElementById("viewCommissionOverrideType").textContent =
    c.overrideType;
  ...
  document.getElementById("viewCommissionPlatformFee").textContent =
    c.platformFee;
  ...
  if (historyBody) {
    ...
    if (c.history.length === 0) {
      historyBody.innerHTML =
        '<tr><td colspan="5" style="text-align:center;color:var(--text-secondary)">No changes recorded</td></tr>';
    } else {
  ...
  if (invoicesDiv) {
    ...
    if (c.invoices.length === 0) {
      ...
      c.invoices.forEach(function (inv) {
        var invStatusClass =
          inv.status === "Paid" ? "status-active" : "status-pending";
        invoicesDiv.innerHTML +=
          '<div class="info-item"><span class="info-label"><i class="fas fa-file-invoice"></i> ' +
          inv.id +
          " (" +
          inv.period +
...
function initializeCommissionEditPage() {
  ...
  document.getElementById("editCommissionVendorLabel").textContent =
    c.vendorType;
  ...
  if (vendorTypeSelect)
    vendorTypeSelect.value = typeMap[c.vendorType] || "hotel";
  ...
  if (commTypeSelect)
    commTypeSelect.value = commTypeMap[c.commissionType] || "percentage";

  document.getElementById("editCommissionRate").value = c.rateValue;
  document.getElementById("editCommissionMin").value =
    parseInt(c.minCommission.replace(/[^0-9]/g, "")) || 0;
  document.getElementById("editCommissionMax").value =
    parseInt(c.maxCommission.replace(/[^0-9]/g, "")) || 0;
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      if (saveBtn) {
        ...
        saveBtn.style.opacity = "0.8";
        setTimeout(function () {
          window.location.href = "commission-view.html?id=" + commissionId;
        }, 1200);
      }
    });
  }
...
var adsRateData = {
  "RATE-001": {
    ...
    baseRate: 25,
    effectiveRate: 30,
    durationTier: "24-72 hours",
    lockIn: "Rate locked at approval",
    status: "active",
    effectiveDate: "Jan 01, 2026",
    expiryDate: "Jun 30, 2026",
    totalBilled: "SAR 12,400",
    createdBy: "Admin User",
    minHours: 4,
    maxHours: 720,
    minSpend: 100,
  ...
  "RATE-002": {
    ...
    baseRate: 40,
    effectiveRate: 45,
    durationTier: "24-168 hours",
    lockIn: "Rate locked at campaign start",
    status: "active",
    effectiveDate: "Feb 01, 2026",
    expiryDate: "Jul 31, 2026",
    totalBilled: "SAR 22,800",
    createdBy: "Admin User",
    minHours: 12,
    maxHours: 720,
    minSpend: 200,
  ...
  "RATE-003": {
    ...
    baseRate: 35,
    effectiveRate: 38,
    durationTier: "72-168 hours",
    lockIn: "Rate locked at approval",
    status: "active",
    effectiveDate: "Jan 15, 2026",
    expiryDate: "Jul 14, 2026",
    totalBilled: "SAR 18,200",
    createdBy: "Admin User",
    minHours: 24,
    maxHours: 720,
    minSpend: 500,
    ...
    campaigns: [
      {
        name: "Sponsored Packages",
        vendor: "Desert Adventures",
        hours: 168,
        cost: "SAR 5,880",
      },
    ],
  ...
  "RATE-004": {
    ...
    baseRate: 50,
    effectiveRate: 55,
    durationTier: "1-24 hours",
    lockIn: "No lock-in (dynamic)",
    status: "active",
    effectiveDate: "Mar 01, 2026",
    expiryDate: "Aug 31, 2026",
    totalBilled: "SAR 8,600",
    createdBy: "Admin User",
    minHours: 1,
    maxHours: 48,
    minSpend: 50,
  ...
  "RATE-005": {
    ...
    campaigns: [
      {
        name: "Long-term Banner Q4",
        vendor: "Jeddah Seaside",
        hours: 720,
        cost: "SAR 14,400",
      },
    ],
  ...
  "RATE-006": {
    ...
    lockIn: "Rate locked at campaign start",
    status: "expired",
    effectiveDate: "Jul 01, 2025",
    expiryDate: "Dec 31, 2025",
    totalBilled: "SAR 15,600",
    createdBy: "Admin User",
    minHours: 72,
    maxHours: 720,
    minSpend: 2000,
...
function populateAdsRateTable() {
  ...
  Object.keys(adsRateData).forEach(function (key) {
    ...
    tbody.innerHTML +=
      ...
      r.id +
      "</strong></td>" +
      '<td><span class="ads-type-badge ads-type-' +
      r.adType.toLowerCase().replace(" ", "-") +
      '">' +
      r.adType +
      "</span></td>" +
      "<td><strong>SAR " +
      ...
      "<td>" +
      lockIcon +
      (r.lockIn.indexOf("locked") > -1 ? "Yes" : "No") +
      "</td>" +
      '<td><span class="status-badge ' +
      statusClass +
      '">' +
      ...
      "</span></td>" +
      '<td><div class="action-buttons">' +
      '<a href="ads-rate-view.html?id=' +
      r.id +
      '" class="action-btn action-view" title="View"><i class="fas fa-eye"></i></a>' +
      '<a href="ads-rate-edit.html?id=' +
      r.id +
      '" class="action-btn action-edit" title="Edit"><i class="fas fa-pen"></i></a>' +
      "</div></td>" +
      "</tr>";
...
function filterAdsRateTable() {
  var searchTerm = (
    document.getElementById("adsRateSearchInput").value || ""
  ).toLowerCase();
  var typeFilter = document.getElementById("adsRateTypeFilter").value || "all";
  var statusFilter =
    document.getElementById("adsRateStatusFilter").value || "all";
...
function initializeAdsRateViewPage() {
  ...
  if (!r) {
    window.location.href = "ads-rate.html";
    return;
  }

  document.getElementById("viewAdsRateId").textContent = r.id;
  document.getElementById("viewAdsRateAdType").textContent = r.adType + " Ad";
  document.getElementById("viewAdsRateStatus").textContent =
    r.status.charAt(0).toUpperCase() + r.status.slice(1);
  document.getElementById("viewAdsRateStatus").className =
    "status-badge status-" + r.status;
  document.getElementById("viewAdsRateBase").textContent =
    "SAR " + r.baseRate + "/hr";
  document.getElementById("viewAdsRateEffective").textContent =
    "SAR " + r.effectiveRate + "/hr";
  ...
  document.getElementById("viewAdsRateEffectiveDate").textContent =
    r.effectiveDate;
  ...
  if (historyBody) {
    ...
    if (r.history.length === 0) {
      historyBody.innerHTML =
        '<tr><td colspan="4" style="text-align:center;color:var(--text-secondary)">No rate changes recorded</td></tr>';
    } else {
  ...
  if (campaignsDiv) {
    ...
    if (r.campaigns.length === 0) {
      campaignsDiv.innerHTML =
        '<p style="color:var(--text-secondary)">No active campaigns using this rate</p>';
    } else {
      r.campaigns.forEach(function (camp) {
        campaignsDiv.innerHTML +=
          '<div class="info-item"><span class="info-label"><i class="fas fa-bullhorn"></i> ' +
          camp.name +
          " (" +
          camp.vendor +
          ')</span><span class="info-value">' +
...
function initializeAdsRateEditPage() {
  ...
  document.getElementById("editAdsRateAdTypeLabel").textContent =
    r.adType + " Ad";
  ...
  var lockInMap = {
    "Rate locked at approval": "approval",
    "Rate locked at campaign start": "start",
    "No lock-in (dynamic)": "none",
  };
  ...
  var invoiceMap = {
    Automatic: "auto",
    Manual: "manual",
    "On Campaign Completion": "on-completion",
  };
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      if (saveBtn) {
        ...
        saveBtn.style.opacity = "0.8";
        setTimeout(function () {
          window.location.href = "ads-rate-view.html?id=" + rateId;
        }, 1200);
      }
    });
  }
...
function initializeSubAdminManagement() {
  ...
  function filterTable() {
    ...
    rows.forEach(function (row) {
      ...
      var roleText = roleBadge
        ? roleBadge.textContent.toLowerCase().replace(/\s+/g, "-")
        : "";
...
function initializeSubAdminEditPage() {
  ...
  function applyRolePreset(modules) {
    ...
    document
      .querySelectorAll('.permission-actions input[type="checkbox"]')
      .forEach(function (cb) {
        cb.checked = false;
      });
    ...
    modules.forEach(function (mod) {
      var moduleCheckbox = document.querySelector(
        '.module-checkbox[data-module="' + mod + '"]',
      );
      if (moduleCheckbox) {
        ...
        document
          .querySelectorAll(
            '.permission-actions input[data-module="' + mod + '"]',
          )
          .forEach(function (cb) {
            cb.checked = true;
          });
  ...
  document
    .querySelectorAll('.permission-actions input[type="checkbox"]')
    .forEach(function (permCheckbox) {
      permCheckbox.addEventListener("change", function () {
        var mod = this.getAttribute("data-module");
        var anyChecked = document.querySelector(
          '.permission-actions input[data-module="' + mod + '"]:checked',
        );
        var moduleCheckbox = document.querySelector(
          '.module-checkbox[data-module="' + mod + '"]',
        );
  ...
  if (selectAllBtn) {
    selectAllBtn.addEventListener("click", function (e) {
      ...
      document
        .querySelectorAll(
          '.module-checkbox, .permission-actions input[type="checkbox"]',
        )
        .forEach(function (cb) {
          cb.checked = true;
        });
  ...
  if (firstNameInput)
    firstNameInput.addEventListener("input", updateDisplayInfo);
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      var permissions = {};
      document
        .querySelectorAll(".module-checkbox:checked")
        .forEach(function (cb) {
      ...
      alert(
        "Sub admin saved successfully with " +
...
function initializeSubAdminViewPage() {
  ...
  if (resetPwBtn) {
    resetPwBtn.addEventListener("click", function () {
      if (
        confirm(
          "Are you sure you want to reset this sub admin's password? They will receive a reset link via email.",
        )
      ) {
...
function initializeAddPageForm(form, redirectUrl, label) {
  form.addEventListener("submit", function (e) {
    ...
    if (submitBtn) {
      submitBtn.innerHTML =
        '<i class="fas fa-check"></i> ' + label + " Created";
